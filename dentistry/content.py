   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      'A': 'The maxillary canine is a long-erupting anterior tooth and the second most commonly impacted tooth. It fails this stem, which requires Mandibular third molar: Mandibular third molars are the teeth most frequently impacted because they erupt last and often lack adequate space in the dental arch.',
      ...
      'C': 'The maxillary lateral incisor is a single-rooted anterior tooth; true bony impaction is uncommon versus agenesis. It fails this stem, which requires Mandibular third molar: Mandibular third molars are the teeth most frequently impacted because they erupt last and often lack adequate space in the dental arch.',
      'D': 'The mandibular first premolar is a bicuspid that usually erupts with space and is rarely fully impacted. It fails this stem, which requires Mandibular third molar: Mandibular third molars are the teeth most frequently impacted because they erupt last and often lack adequate space in the dental arch.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'The mental foramen transmits the mental nerve onto the buccal mandibular premolar region. It fails this stem, which requires Mandibular foramen on the medial ramus: The inferior alveolar nerve enters the mandible at the mandibular foramen on the medial ramus.',
      'B': 'The infraorbital foramen on the maxilla transmits the infraorbital nerve to midface soft tissues. It fails this stem, which requires Mandibular foramen on the medial ramus: The inferior alveolar nerve enters the mandible at the mandibular foramen on the medial ramus.',
      ...
      'D': 'The greater palatine foramen transmits the greater palatine nerve to posterior hard-palate mucosa. It fails this stem, which requires Mandibular foramen on the medial ramus: The inferior alveolar nerve enters the mandible at the mandibular foramen on the medial ramus.'
     }
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Fluoride varnish deposits high-concentration fluoride on enamel to favor remineralization. It fails this stem, which requires Difficult mandibular molar extraction with clot loss: Alveolar osteitis (dry socket) follows premature loss or lysis of the blood clot that normally protects the extraction socket.',
      'C': 'Supragingival scaling mechanically removes coronal calculus/biofilm without creating a socket. It fails this stem, which requires Difficult mandibular molar extraction with clot loss: Alveolar osteitis (dry socket) follows premature loss or lysis of the blood clot that normally protects the extraction socket.',
      'D': 'Orthodontic bonding adhesively fixes brackets to enamel without opening alveolar bone. It fails this stem, which requires Difficult mandibular molar extraction with clot loss: Alveolar osteitis (dry socket) follows premature loss or lysis of the blood clot that normally protects the extraction socket.'
     }
    }
   ],
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'The TMJ capsule is the synovial envelope of the condyle–temporal joint, not floor-of-mouth spaces. It fails this stem, which requires Bilateral submandibular, sublingual, and submental spaces: Ludwig angina is a rapidly spreading bilateral cellulitis of the submandibular, sublingual, and submental spaces, usually from an odontogenic source.',
      'B': 'Isolated maxillary sinus disease is confined to one antrum and is not bilateral floor-of-mouth cellulitis. It fails this stem, which requires Bilateral submandibular, sublingual, and submental spaces: Ludwig angina is a rapidly spreading bilateral cellulitis of the submandibular, sublingual, and submental spaces, usually from an odontogenic source.',
      'C': 'The pulp chamber and canals contain dental pulp within tooth structure, not cervical fascial spaces. It fails this stem, which requires Bilateral submandibular, sublingual, and submental spaces: Ludwig angina is a rapidly spreading bilateral cellulitis of the submandibular, sublingual, and submental spaces, usually from an odontogenic source.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'HbA1c averages glycemia over ~3 months and does not quantify warfarin anticoagulation. It fails this stem, which requires INR (international normalized ratio): Warfarin inhibits vitamin K–dependent clotting factors and is monitored with the international normalized ratio (INR).',
      ...
      'C': 'Serum amylase is a pancreatic/salivary enzyme marker, mainly for pancreatitis assessment. It fails this stem, which requires INR (international normalized ratio): Warfarin inhibits vitamin K–dependent clotting factors and is monitored with the international normalized ratio (INR).',
      'D': 'A fasting lipid panel quantifies cholesterol/triglycerides for cardiovascular risk, not bleeding risk. It fails this stem, which requires INR (international normalized ratio): Warfarin inhibits vitamin K–dependent clotting factors and is monitored with the international normalized ratio (INR).'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Mandibular incisor apices lie in anterior mandibular bone remote from the maxillary sinus. It fails this stem, which requires Maxillary molars: Maxillary molar roots often lie close to, or project into, the maxillary sinus floor.',
      'B': 'Mandibular canine roots occupy the anterior mandible and do not abut the maxillary antrum. It fails this stem, which requires Maxillary molars: Maxillary molar roots often lie close to, or project into, the maxillary sinus floor.',
      'C': 'Mandibular premolars sit in the posterior mandible, distant from the maxillary sinus floor. It fails this stem, which requires Maxillary molars: Maxillary molar roots often lie close to, or project into, the maxillary sinus floor.',
   ...
   'hard': [
    {
     ...
     'choice_explanations': {
      'A': 'The lingual nerve carries tongue sensation/taste and runs near the lingual plate in the third-molar area. It fails this stem, which requires Inferior alveolar nerve: The inferior alveolar nerve runs in the mandibular canal and may lie immediately adjacent to mandibular third molar roots.',
      'B': 'The facial nerve (CN VII) traverses the parotid gland to motorize muscles of facial expression. It fails this stem, which requires Inferior alveolar nerve: The inferior alveolar nerve runs in the mandibular canal and may lie immediately adjacent to mandibular third molar roots.',
      ...
      'D': 'The hypoglossal nerve (CN XII) motorizes tongue muscles in the neck, remote from the mandibular canal. It fails this stem, which requires Inferior alveolar nerve: The inferior alveolar nerve runs in the mandibular canal and may lie immediately adjacent to mandibular third molar roots.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Removable retainers stabilize tooth position without surgically disrupting jaw mucosa or bone. It fails this stem, which requires Invasive dental surgery in patients on antiresorptive therapy: Medication-related osteonecrosis of the jaw (MRONJ) is exposed necrotic bone associated with antiresorptive or antiangiogenic drugs.',
      'B': 'Fluoride varnish deposits high-concentration fluoride on enamel to favor remineralization. It fails this stem, which requires Invasive dental surgery in patients on antiresorptive therapy: Medication-related osteonecrosis of the jaw (MRONJ) is exposed necrotic bone associated with antiresorptive or antiangiogenic drugs.',
      'C': 'Atraumatic prophylaxis does not create the mucosal/osseous wound that precipitates MRONJ. It fails this stem, which requires Invasive dental surgery in patients on antiresorptive therapy: Medication-related osteonecrosis of the jaw (MRONJ) is exposed necrotic bone associated with antiresorptive or antiangiogenic drugs.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'RCT disinfects and obturates pulp space; it cannot retrieve a foreign body from the sinus. It fails this stem, which requires Retrieval strategy with sinus precautions and possible referral: A root tip displaced into the maxillary sinus can act as a foreign body, promoting sinusitis or sustaining an oroantral fistula.',
      ...
      'C': 'Indefinite observation without imaging ignores foreign-body sinusitis and oroantral fistula risk. It fails this stem, which requires Retrieval strategy with sinus precautions and possible referral: A root tip displaced into the maxillary sinus can act as a foreign body, promoting sinusitis or sustaining an oroantral fistula.',
      'D': 'Chlorhexidine is an antimicrobial rinse and does not remove a root tip from the antrum. It fails this stem, which requires Retrieval strategy with sinus precautions and possible referral: A root tip displaced into the maxillary sinus can act as a foreign body, promoting sinusitis or sustaining an oroantral fistula.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      'A': 'Abrupt anticoagulant cessation restores thrombotic risk (stroke/VTE) by removing pathway inhibition. It fails this stem, which requires Coordinate physician guidance; use local hemostasis; avoid blind anticoagulant cessation: Therapeutic anticoagulation reduces thromboembolic risk; abrupt cessation can precipitate stroke or venous thrombosis.',
      'B': 'Blanket refusal ignores that many extractions proceed safely with local hemostasis on anticoagulation. It fails this stem, which requires Coordinate physician guidance; use local hemostasis; avoid blind anticoagulant cessation: Therapeutic anticoagulation reduces thromboembolic risk; abrupt cessation can precipitate stroke or venous thrombosis.',
      'C': 'Vitamin K repletes cofactors II/VII/IX/X and reverses warfarin only when clinically indicated. It fails this stem, which requires Coordinate physician guidance; use local hemostasis; avoid blind anticoagulant cessation: Therapeutic anticoagulation reduces thromboembolic risk; abrupt cessation can precipitate stroke or venous thrombosis.',
    ...
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Outpatient antibiotics do not secure an airway threatened by expanding hematoma. It fails this stem, which requires Airway emergency management first: An expanding neck hematoma after surgery can compress the airway, producing stridor, dyspnea, and rapid desaturation.',
      'C': 'Observation without airway assessment leaves progressive airway compression untreated. It fails this stem, which requires Airway emergency management first: An expanding neck hematoma after surgery can compress the airway, producing stridor, dyspnea, and rapid desaturation.',
      'D': 'Ice packs do not relieve mechanical airway obstruction from expanding hematoma. It fails this stem, which requires Airway emergency management first: An expanding neck hematoma after surgery can compress the airway, producing stridor, dyspnea, and rapid desaturation.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Physiologic primary exfoliation is not radiotherapy-related osteoradionecrosis risk. It fails this stem, which requires Extractions in previously irradiated jaws: High-dose radiotherapy damages bone vasculature and cellularity in the jaws, impairing healing after trauma.',
      'B': 'Sealants are preventive resin coatings of pits/fissures without irradiated-bone trauma. It fails this stem, which requires Extractions in previously irradiated jaws: High-dose radiotherapy damages bone vasculature and cellularity in the jaws, impairing healing after trauma.',
      ...
      'D': 'Whitening trays deliver peroxide to enamel and do not create ORN-level osseous injury. It fails this stem, which requires Extractions in previously irradiated jaws: High-dose radiotherapy damages bone vasculature and cellularity in the jaws, impairing healing after trauma.'
     }
    }
   ]
  },
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Mesial mandibular molar position relative to Class I defines Angle Class III, not Class II. It fails this stem, which requires Mandibular first molar distal relative to the maxillary first molar: In Angle’s classification, Class II molar occlusion means the mandibular first molar is positioned distal to its normal relation with the maxillary first molar.',
      'C': 'Anterior open bite is a vertical discrepancy and does not define Class II molar occlusion. It fails this stem, which requires Mandibular first molar distal relative to the maxillary first molar: In Angle’s classification, Class II molar occlusion means the mandibular first molar is positioned distal to its normal relation with the maxillary first molar.',
      'D': 'Posterior crossbite is transverse and does not define Class II anteroposterior molar relation. It fails this stem, which requires Mandibular first molar distal relative to the maxillary first molar: In Angle’s classification, Class II molar occlusion means the mandibular first molar is positioned distal to its normal relation with the maxillary first molar.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Vertical incisor overlap is overbite, a different dimension from horizontal overjet. It fails this stem, which requires Horizontal overlap of the incisors: Overjet is the horizontal distance between the labial surface of the mandibular incisors and the incisal edges of the maxillary incisors.',
      ...
      'C': 'Molar torque is buccolingual crown inclination, not horizontal incisor overlap. It fails this stem, which requires Horizontal overlap of the incisors: Overjet is the horizontal distance between the labial surface of the mandibular incisors and the incisal edges of the maxillary incisors.',
      'D': 'Arch-length discrepancy compares total tooth size with available arch perimeter. It fails this stem, which requires Horizontal overlap of the incisors: Overjet is the horizontal distance between the labial surface of the mandibular incisors and the incisal edges of the maxillary incisors.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Periodontal splinting stabilizes mobile adult teeth; it does not preserve successor space. It fails this stem, which requires Premature loss of a primary tooth risks space loss for the successor: Early loss of a primary tooth allows adjacent teeth to drift into the edentulous space, shortening arch length and risking impaction or crowding of the successor.',
      'B': 'Bleaching trays hold peroxide gel and do not maintain mesiodistal arch length. It fails this stem, which requires Premature loss of a primary tooth risks space loss for the successor: Early loss of a primary tooth allows adjacent teeth to drift into the edentulous space, shortening arch length and risking impaction or crowding of the successor.',
      ...
      'D': 'Direct pulp capping treats pulp exposure with a biocompatible dressing; it is not space maintenance. It fails this stem, which requires Premature loss of a primary tooth risks space loss for the successor: Early loss of a primary tooth allows adjacent teeth to drift into the edentulous space, shortening arch length and risking impaction or crowding of the successor.'
     }
    }
   ],
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'Habits alone do not explain a unilateral crossbite with a reproducible functional mandibular shift. It fails this stem, which requires Premature contact or occlusal interference deflecting closure: A unilateral posterior crossbite with a mandibular functional shift often results from a premature occlusal contact that deflects the mandible on closure.',
      'B': 'Fluorosis is enamel hypomineralization from excess fluoride intake during formation. It fails this stem, which requires Premature contact or occlusal interference deflecting closure: A unilateral posterior crossbite with a mandibular functional shift often results from a premature occlusal contact that deflects the mandible on closure.',
      'C': 'Interproximal caries without premature contacts does not deflect mandibular closure. It fails this stem, which requires Premature contact or occlusal interference deflecting closure: A unilateral posterior crossbite with a mandibular functional shift often results from a premature occlusal contact that deflects the mandible on closure.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Wire cross-section determines stiffness and force delivery, not the definition of anchorage. It fails this stem, which requires Resistance to unwanted reciprocal tooth movement: Anchorage is the resistance to unwanted reciprocal tooth movement that Newton’s third law would otherwise produce during orthodontic force application.',
      ...
      'C': 'Ceramic shade is an esthetic selection unrelated to reciprocal-force resistance. It fails this stem, which requires Resistance to unwanted reciprocal tooth movement: Anchorage is the resistance to unwanted reciprocal tooth movement that Newton’s third law would otherwise produce during orthodontic force application.',
      'D': 'Ligature flavor is patient preference and has no biomechanical anchorage meaning. It fails this stem, which requires Resistance to unwanted reciprocal tooth movement: Anchorage is the resistance to unwanted reciprocal tooth movement that Newton’s third law would otherwise produce during orthodontic force application.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Mandibular tori are benign lingual bony exostoses unrelated to digit-habit vectors. It fails this stem, which requires Anterior open bite and proclined maxillary incisors: Prolonged non-nutritive sucking generates forward and intrusive forces on the maxillary incisors and impedes normal eruption of the anteriors.',
      'B': 'Dens invaginatus is an enamel-organ infolding that can channel bacteria toward the pulp. It fails this stem, which requires Anterior open bite and proclined maxillary incisors: Prolonged non-nutritive sucking generates forward and intrusive forces on the maxillary incisors and impedes normal eruption of the anteriors.',
      'C': 'Enamel pearls are ectopic enamel droplets on root surfaces, often near furcations. It fails this stem, which requires Anterior open bite and proclined maxillary incisors: Prolonged non-nutritive sucking generates forward and intrusive forces on the maxillary incisors and impedes normal eruption of the anteriors.',
   ...
   'hard': [
    {
     ...
     'choice_explanations': {
      'A': 'Mouthwash formulation does not generate the PDL stress that drives orthodontic root resorption. It fails this stem, which requires Heavy prolonged forces and certain root morphologies: Orthodontic tooth movement depends on controlled periodontal ligament stress; heavy or prolonged forces can trigger sterile inflammation and clastic activity on the root surface.',
      'B': 'Dentifrice brand does not determine sterile clastic activity on the root surface. It fails this stem, which requires Heavy prolonged forces and certain root morphologies: Orthodontic tooth movement depends on controlled periodontal ligament stress; heavy or prolonged forces can trigger sterile inflammation and clastic activity on the root surface.',
      'C': 'Flossing does not create the heavy prolonged orthodontic forces linked to apical resorption. It fails this stem, which requires Heavy prolonged forces and certain root morphologies: Orthodontic tooth movement depends on controlled periodontal ligament stress; heavy or prolonged forces can trigger sterile inflammation and clastic activity on the root surface.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Third-molar removal alone is not the guided mixed-dentition sequence called serial extraction. It fails this stem, which requires A guided sequence of primary then selected permanent extractions for severe crowding: Serial extraction is a planned sequence of primary and then selected permanent tooth removals in the mixed dentition when severe crowding is inevitable.',
      ...
      'C': 'Endodontic therapy treats pulp/periapex and is not orthodontic serial extraction. It fails this stem, which requires A guided sequence of primary then selected permanent extractions for severe crowding: Serial extraction is a planned sequence of primary and then selected permanent tooth removals in the mixed dentition when severe crowding is inevitable.',
      'D': 'Scaling removes biofilm/calculus; it is not a guided extraction protocol for crowding. It fails this stem, which requires A guided sequence of primary then selected permanent extractions for severe crowding: Serial extraction is a planned sequence of primary and then selected permanent tooth removals in the mixed dentition when severe crowding is inevitable.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Fluoride-releasing materials remineralize enamel; that is not the function of TADs. It fails this stem, which requires Skeletal anchorage independent of reciprocal tooth support: Temporary anchorage devices (TADs) are mini-implants or plates fixed to bone to provide absolute or near-absolute anchorage.',
      'B': 'Bleaching activates peroxide on enamel and is unrelated to skeletal anchorage. It fails this stem, which requires Skeletal anchorage independent of reciprocal tooth support: Temporary anchorage devices (TADs) are mini-implants or plates fixed to bone to provide absolute or near-absolute anchorage.',
      ...
      'D': 'Local anesthetics block nerve conduction; TADs are not soft-tissue drug depots. It fails this stem, which requires Skeletal anchorage independent of reciprocal tooth support: Temporary anchorage devices (TADs) are mini-implants or plates fixed to bone to provide absolute or near-absolute anchorage.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      'A': 'Heavy forces through inflamed periodontium can accelerate attachment loss. It fails this stem, which requires Periodontal disease control first, light forces, and perio co-management: Periodontitis involves plaque-driven inflammation and progressive attachment loss; orthodontic forces applied through an inflamed periodontium can accelerate destruction.',
      'B': 'Ignoring bone levels risks loading an unsupported periodontium and worsening destruction. It fails this stem, which requires Periodontal disease control first, light forces, and perio co-management: Periodontitis involves plaque-driven inflammation and progressive attachment loss; orthodontic forces applied through an inflamed periodontium can accelerate destruction.',
      'C': 'Pan-extraction is not required; controlled orthodontics after perio therapy can be appropriate. It fails this stem, which requires Periodontal disease control first, light forces, and perio co-management: Periodontitis involves plaque-driven inflammation and progressive attachment loss; orthodontic forces applied through an inflamed periodontium can accelerate destruction.',
    ...
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Facial freckling is melanocytic pigmentation unrelated to ectopic canine mechanics. It fails this stem, which requires Root resorption of adjacent incisors: An ectopically erupting maxillary canine can physically resorb the roots of adjacent lateral or central incisors through direct contact and pressure.',
      'C': 'Geographic tongue is benign migratory glossitis with migrating filiform-papilla atrophy. It fails this stem, which requires Root resorption of adjacent incisors: An ectopically erupting maxillary canine can physically resorb the roots of adjacent lateral or central incisors through direct contact and pressure.',
      'D': 'Hairy tongue is elongated filiform papillae with retained debris, unrelated to canine ectopia. It fails this stem, which requires Root resorption of adjacent incisors: An ectopically erupting maxillary canine can physically resorb the roots of adjacent lateral or central incisors through direct contact and pressure.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Bracket prescription affects mechanics but does not decide surgical vs camouflage Class III. It fails this stem, which requires Growth status, severity, facial profile, and occlusal discrepancy: Class III malocclusion may be dental, skeletal, or combined; treatment choice depends on remaining growth, skeletal severity, soft-tissue profile, and occlusal discrepancy.',
      'B': 'Wire alloy affects force delivery, not skeletal severity/profile criteria for Class III surgery. It fails this stem, which requires Growth status, severity, facial profile, and occlusal discrepancy: Class III malocclusion may be dental, skeletal, or combined; treatment choice depends on remaining growth, skeletal severity, soft-tissue profile, and occlusal discrepancy.',
      'C': 'Class III malocclusion may be dental, skeletal, or combined; treatment choice depends on remaining growth, skeletal severity, soft-tissue profile, and occlusal discrepancy. Mild dental Class III may be camouflaged, whereas severe skeletal discrepancies often need orthognathic surgery after growth assessment.',
      'D': 'Appointment length is logistical and unrelated to skeletal Class III treatment choice. It fails this stem, which requires Growth status, severity, facial profile, and occlusal discrepancy: Class III malocclusion may be dental, skeletal, or combined; treatment choice depends on remaining growth, skeletal severity, soft-tissue profile, and occlusal discrepancy.'
     }
    }
   ]
  },
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Class II molar relation is occlusal discrepancy and does not by itself cause plaque gingivitis. It fails this stem, which requires Dental biofilm at the gingival margin: Plaque-induced gingivitis is an inflammatory response of the gingiva to accumulation of dental biofilm at the gingival margin.',
      'C': 'Dens evaginatus is an occlusal enamel tubercle that can pulp-expose with wear/fracture. It fails this stem, which requires Dental biofilm at the gingival margin: Plaque-induced gingivitis is an inflammatory response of the gingiva to accumulation of dental biofilm at the gingival margin.',
      'D': 'Torus palatinus is a benign midline palatal exostosis unrelated to plaque gingivitis. It fails this stem, which requires Dental biofilm at the gingival margin: Plaque-induced gingivitis is an inflammatory response of the gingiva to accumulation of dental biofilm at the gingival margin.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Marginal redness without attachment loss defines gingivitis, not periodontitis. It fails this stem, which requires Clinical attachment loss and alveolar bone loss: Gingivitis is inflammation confined to the soft tissue, whereas periodontitis is defined by destruction of the periodontal ligament and alveolar bone, measured as clinical attachment loss.',
      ...
      'C': 'Extrinsic stain is surface pigment and does not define periodontitis. It fails this stem, which requires Clinical attachment loss and alveolar bone loss: Gingivitis is inflammation confined to the soft tissue, whereas periodontitis is defined by destruction of the periodontal ligament and alveolar bone, measured as clinical attachment loss.',
      'D': 'Calculus harbors biofilm but periodontitis requires inflammatory attachment/bone loss. It fails this stem, which requires Clinical attachment loss and alveolar bone loss: Gingivitis is inflammation confined to the soft tissue, whereas periodontitis is defined by destruction of the periodontal ligament and alveolar bone, measured as clinical attachment loss.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Whitening strips deliver peroxide for stain and do not adequately disrupt interdental biofilm. It fails this stem, which requires Toothbrushing with interdental cleaning: Dental biofilm must be disrupted mechanically because saliva and rinses alone do not remove adherent plaque from tooth surfaces.',
      'B': 'Chewing ice risks dental injury and is not an effective plaque-control method. It fails this stem, which requires Toothbrushing with interdental cleaning: Dental biofilm must be disrupted mechanically because saliva and rinses alone do not remove adherent plaque from tooth surfaces.',
      ...
      'D': 'Charcoal powder lacks proven mechanical biofilm control and may abrade tissues/restorations. It fails this stem, which requires Toothbrushing with interdental cleaning: Dental biofilm must be disrupted mechanically because saliva and rinses alone do not remove adherent plaque from tooth surfaces.'
     }
    }
   ],
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'Maxillary central incisors are single-rooted and have no furcation to probe. It fails this stem, which requires Multirooted teeth such as molars: Furcation involvement is pathologic bone loss between the roots of multirooted teeth, exposing the furcation entrance.',
      'B': 'Mandibular canine roots occupy the anterior mandible and do not abut the maxillary antrum. It fails this stem, which requires Multirooted teeth such as molars: Furcation involvement is pathologic bone loss between the roots of multirooted teeth, exposing the furcation entrance.',
      'C': 'Primary lateral incisors are single-rooted and lack furcations. It fails this stem, which requires Multirooted teeth such as molars: Furcation involvement is pathologic bone loss between the roots of multirooted teeth, exposing the furcation entrance.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Smoking does not protect attachment; it impairs host response and worsens periodontitis. It fails this stem, which requires Increases risk and severity while masking bleeding: Tobacco smoking impairs neutrophil function, reduces gingival blood flow, and alters cytokine responses, increasing periodontitis risk and severity.',
      ...
      'C': 'Smoking does not therapeutically whiten roots or spare periodontal tissues. It fails this stem, which requires Increases risk and severity while masking bleeding: Tobacco smoking impairs neutrophil function, reduces gingival blood flow, and alters cytokine responses, increasing periodontitis risk and severity.',
      'D': 'Smoking has a documented adverse effect on periodontitis risk and healing. It fails this stem, which requires Increases risk and severity while masking bleeding: Tobacco smoking impairs neutrophil function, reduces gingival blood flow, and alters cytokine responses, increasing periodontitis risk and severity.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Cervical abrasion is mechanical tooth wear, not aggressive periodontitis attachment loss. It fails this stem, which requires Severe attachment loss out of proportion to deposits, with A. actinomycetemcomitans often discussed: Rapidly progressive periodontitis in young patients (historically localized aggressive periodontitis) features severe attachment loss out of proportion to local deposits.',
      'B': 'Fluorosis is enamel hypomineralization without periodontal attachment loss. It fails this stem, which requires Severe attachment loss out of proportion to deposits, with A. actinomycetemcomitans often discussed: Rapidly progressive periodontitis in young patients (historically localized aggressive periodontitis) features severe attachment loss out of proportion to local deposits.',
      'C': 'Attrition alone does not produce plaque-associated rapid attachment-loss patterns. It fails this stem, which requires Severe attachment loss out of proportion to deposits, with A. actinomycetemcomitans often discussed: Rapidly progressive periodontitis in young patients (historically localized aggressive periodontitis) features severe attachment loss out of proportion to local deposits.',
   ...
   'hard': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Bleaching trays do not drain pocket pus or debride a periodontal abscess. It fails this stem, which requires Drainage and debridement, with antimicrobials if systemic signs: A periodontal abscess is a localized purulent infection within a periodontal pocket or furcation.',
      'C': 'Orthodontic wax shields mucosa from brackets; it does not treat periodontal abscess. It fails this stem, which requires Drainage and debridement, with antimicrobials if systemic signs: A periodontal abscess is a localized purulent infection within a periodontal pocket or furcation.',
      'D': 'A nightguard modifies occlusal load but does not drain or debride acute abscess. It fails this stem, which requires Drainage and debridement, with antimicrobials if systemic signs: A periodontal abscess is a localized purulent infection within a periodontal pocket or furcation.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Peri-implant mucositis is soft-tissue inflammation without progressive crestal bone loss. It fails this stem, which requires Inflammation plus progressive crestal bone loss around an implant: Peri-implant mucositis is reversible soft-tissue inflammation around an implant without progressive bone loss.',
      'B': 'Food impaction alone without inflammation/bone loss does not define peri-implantitis. It fails this stem, which requires Inflammation plus progressive crestal bone loss around an implant: Peri-implant mucositis is reversible soft-tissue inflammation around an implant without progressive bone loss.',
      ...
      'D': 'Shade mismatch is esthetic and not a biologic peri-implant disease definition. It fails this stem, which requires Inflammation plus progressive crestal bone loss around an implant: Peri-implant mucositis is reversible soft-tissue inflammation around an implant without progressive bone loss.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Occlusal trauma alone does not initiate the plaque-driven periodontitis pathway. It fails this stem, which requires Does not initiate the plaque-induced periodontitis pathway: Occlusal trauma produces adaptive or pathologic changes in the periodontium from excessive occlusal load, but it does not initiate the plaque-induced inflammatory pathway of periodontitis.',
      'B': 'Occlusal therapy does not replace biofilm debridement needed for inflammatory pockets. It fails this stem, which requires Does not initiate the plaque-induced periodontitis pathway: Occlusal trauma produces adaptive or pathologic changes in the periodontium from excessive occlusal load, but it does not initiate the plaque-induced inflammatory pathway of periodontitis.',
      'C': 'Occlusal adjustment cannot substitute for mechanical disruption of pathogenic biofilm. It fails this stem, which requires Does not initiate the plaque-induced periodontitis pathway: Occlusal trauma produces adaptive or pathologic changes in the periodontium from excessive occlusal load, but it does not initiate the plaque-induced inflammatory pathway of periodontitis.',
   ...
   'extreme': [
    {
     ...
     'choice_explanations': {
      'A': 'Peg laterals are a crown-form anomaly, not the NUG clinical triad. It fails this stem, which requires Pain, bleeding, and interdental papillary necrosis with fetor: Necrotizing ulcerative gingivitis presents with painful punched-out interdental papillae, spontaneous bleeding, and often fetor oris.',
      'B': 'Extrinsic stain without necrosis/pain is not necrotizing ulcerative gingivitis. It fails this stem, which requires Pain, bleeding, and interdental papillary necrosis with fetor: Necrotizing ulcerative gingivitis presents with painful punched-out interdental papillae, spontaneous bleeding, and often fetor oris.',
      'C': 'Dens in dente is a developmental invagination, not NUG soft-tissue necrosis. It fails this stem, which requires Pain, bleeding, and interdental papillary necrosis with fetor: Necrotizing ulcerative gingivitis presents with painful punched-out interdental papillae, spontaneous bleeding, and often fetor oris.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Pregnancy epulis is a reactive vascular lesion, not melanoma by default. It fails this stem, which requires A pyogenic granuloma variant that often regresses postpartum: A pregnancy epulis is a pyogenic granuloma arising from gingiva under the influence of elevated pregnancy hormones and local irritants.',
      ...
      'C': 'Osteosarcoma is a malignant bone neoplasm, not a reactive gingival pregnancy epulis. It fails this stem, which requires A pyogenic granuloma variant that often regresses postpartum: A pregnancy epulis is a pyogenic granuloma arising from gingiva under the influence of elevated pregnancy hormones and local irritants.',
      'D': 'Caries is demineralization of tooth hard tissue, not a soft-tissue epulis. It fails this stem, which requires A pyogenic granuloma variant that often regresses postpartum: A pregnancy epulis is a pyogenic granuloma arising from gingiva under the influence of elevated pregnancy hormones and local irritants.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Stain removal is prophylaxis/polishing, not regeneration of periodontal attachment. It fails this stem, which requires Regeneration of a new periodontal attachment apparatus: Guided tissue regeneration uses a barrier membrane to exclude gingival epithelium and connective tissue from the periodontal defect, allowing periodontal ligament and bone cells to repopulate the root surface and form new cementum, PDL, and bone.',
      'B': 'Microabrasion removes superficial enamel defects; it does not regenerate PDL/bone/cementum. It fails this stem, which requires Regeneration of a new periodontal attachment apparatus: Guided tissue regeneration uses a barrier membrane to exclude gingival epithelium and connective tissue from the periodontal defect, allowing periodontal ligament and bone cells to repopulate the root surface and form new cementum, PDL, and bone.',
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Brief non-lingering thermal pain characterizes reversible pulpitis. It fails this stem, which requires Spontaneous and lingering to cold stimuli: Symptomatic irreversible pulpitis reflects vital pulp tissue with inflammation severe enough that it cannot resolve even after removal of the irritant.',
      'C': 'Mucosal itching is not the C-fiber thermal pain pattern of irreversible pulpitis. It fails this stem, which requires Spontaneous and lingering to cold stimuli: Symptomatic irreversible pulpitis reflects vital pulp tissue with inflammation severe enough that it cannot resolve even after removal of the irritant.',
      'D': 'A reciprocal TMJ click indicates disc displacement with reduction, not pulpitis. It fails this stem, which requires Spontaneous and lingering to cold stimuli: Symptomatic irreversible pulpitis reflects vital pulp tissue with inflammation severe enough that it cannot resolve even after removal of the irritant.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Cotton rolls reduce local moisture but cannot reliably isolate canals from saliva/microbes. It fails this stem, which requires Rubber dam isolation of the operating field: A rubber dam isolates the tooth from saliva and oral microbes, preventing contamination of the root canal system during instrumentation and obturation.',
      ...
      'C': 'Suction alone does not prevent salivary contamination of open canals. It fails this stem, which requires Rubber dam isolation of the operating field: A rubber dam isolates the tooth from saliva and oral microbes, preventing contamination of the root canal system during instrumentation and obturation.',
      'D': 'Cheek retractors improve access but do not seal oral fluids from the canal system. It fails this stem, which requires Rubber dam isolation of the operating field: A rubber dam isolates the tooth from saliva and oral microbes, preventing contamination of the root canal system during instrumentation and obturation.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Instrumentation beyond the apex into sinus/bone risks extrusion injury, not physiologic working length. It fails this stem, which requires The apical constriction / near radiographic apex per protocol: The apical constriction is the narrowest point of the canal near the cementoenamel or cementodentinal junction and is the usual physiologic terminus for canal preparation.',
      'B': 'Pulp horns are coronal extensions; working length is measured to the apical canal terminus. It fails this stem, which requires The apical constriction / near radiographic apex per protocol: The apical constriction is the narrowest point of the canal near the cementoenamel or cementodentinal junction and is the usual physiologic terminus for canal preparation.',
      'C': 'CEJ is a coronal landmark, not the apical constriction used for working length. It fails this stem, which requires The apical constriction / near radiographic apex per protocol: The apical constriction is the narrowest point of the canal near the cementoenamel or cementodentinal junction and is the usual physiologic terminus for canal preparation.',
   ...
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'Reversible pulpitis lacks apical radiolucency; necrosis plus lucency indicates apical periodontitis. It fails this stem, which requires Apical periodontitis: Pulp necrosis allows bacteria and their toxins to exit through apical foramina into the periodontal ligament and bone.',
      ...
      'C': 'Enamel hypoplasia is a developmental crown defect, not a periapical radiolucency. It fails this stem, which requires Apical periodontitis: Pulp necrosis allows bacteria and their toxins to exit through apical foramina into the periodontal ligament and bone.',
      'D': 'Fluorosis is enamel hypomineralization from excess fluoride intake during formation. It fails this stem, which requires Apical periodontitis: Pulp necrosis allows bacteria and their toxins to exit through apical foramina into the periodontal ligament and bone.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Sealers fill obturation interfaces; NaOCl is a tissue-dissolving canal irrigant, not a sealer. It fails this stem, which requires An irrigant with tissue-dissolving and antimicrobial action: Sodium hypochlorite dissolves necrotic pulp tissue and has broad antimicrobial activity against canal flora, making it the primary endodontic irrigant.',
      'B': 'Temporary fillings seal access cavities; NaOCl is used as irrigant during instrumentation. It fails this stem, which requires An irrigant with tissue-dissolving and antimicrobial action: Sodium hypochlorite dissolves necrotic pulp tissue and has broad antimicrobial activity against canal flora, making it the primary endodontic irrigant.',
      ...
      'D': 'Local anesthetics block nerve conduction; NaOCl is a cytotoxic irrigant, not an anesthetic. It fails this stem, which requires An irrigant with tissue-dissolving and antimicrobial action: Sodium hypochlorite dissolves necrotic pulp tissue and has broad antimicrobial activity against canal flora, making it the primary endodontic irrigant.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Pain limited to an adjacent intact tooth does not define cracked-tooth bite-release pain. It fails this stem, which requires Release of biting pressure on the affected cusp: In a cracked tooth, occlusal load briefly separates the crack walls and stimulates the pulp or periodontal ligament; pain is characteristically sharp on release of biting pressure as the segments snap back together.',
      'B': 'Thermal pulpitis pain differs from the occlusal bite-release pattern of a cracked tooth. It fails this stem, which requires Release of biting pressure on the affected cusp: In a cracked tooth, occlusal load briefly separates the crack walls and stimulates the pulp or periodontal ligament; pain is characteristically sharp on release of biting pressure as the segments snap back together.',
      'C': 'Posture without occlusal loading does not elicit classic cracked-tooth pain. It fails this stem, which requires Release of biting pressure on the affected cusp: In a cracked tooth, occlusal load briefly separates the crack walls and stimulates the pulp or periodontal ligament; pain is characteristically sharp on release of biting pressure as the segments snap back together.',
   ...
   'hard': [
    {
     ...
     'choice_explanations': {
      'A': 'Enamel stain is not the acute soft-tissue chemical burn of NaOCl extrusion. It fails this stem, which requires Sudden severe pain, swelling, and ecchymosis after irrigation: Forceful extrusion of sodium hypochlorite into periapical tissues causes immediate chemical burns of soft tissue and vessels.',
      'B': 'NaOCl extrusion accidents are immediate, not gradual week-scale pulpitis. It fails this stem, which requires Sudden severe pain, swelling, and ecchymosis after irrigation: Forceful extrusion of sodium hypochlorite into periapical tissues causes immediate chemical burns of soft tissue and vessels.',
      'C': 'Taste change alone does not describe acute pain/swelling/ecchymosis of NaOCl extrusion. It fails this stem, which requires Sudden severe pain, swelling, and ecchymosis after irrigation: Forceful extrusion of sodium hypochlorite into periapical tissues causes immediate chemical burns of soft tissue and vessels.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Missing MB2 leaves untreated canal infection and worsens prognosis. It fails this stem, which requires Persistent infection and treatment failure risk: Maxillary molars frequently have a second mesiobuccal canal (MB2) that branches within the mesiobuccal root.',
      ...
      'C': 'Facial skin color change is unrelated to missed MB2 canal infection. It fails this stem, which requires Persistent infection and treatment failure risk: Maxillary molars frequently have a second mesiobuccal canal (MB2) that branches within the mesiobuccal root.',
      'D': 'Drug-induced gingival overgrowth is a soft-tissue drug effect, not a missed-MB2 sequela. It fails this stem, which requires Persistent infection and treatment failure risk: Maxillary molars frequently have a second mesiobuccal canal (MB2) that branches within the mesiobuccal root.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Complete VRF opens a bacterial pathway that nonsurgical RCT alone rarely heals. It fails this stem, which requires Poor, with extraction commonly required: A complete vertical root fracture separates the root along its long axis, creating a pathway for bacteria from the oral cavity into the periodontium.',
      'B': 'Indefinite observation leaves fracture-associated periodontal destruction progressive. It fails this stem, which requires Poor, with extraction commonly required: A complete vertical root fracture separates the root along its long axis, creating a pathway for bacteria from the oral cavity into the periodontium.',
      ...
      'D': 'Internal bleaching treats intrinsic discoloration and does not repair a fractured root. It fails this stem, which requires Poor, with extraction commonly required: A complete vertical root fracture separates the root along its long axis, creating a pathway for bacteria from the oral cavity into the periodontium.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      'A': 'PDL cells die with prolonged dry time; >60 min dry storage means poor viability. It fails this stem, which requires Poor PDL viability and worsened prognosis; manage per trauma guidelines: Periodontal ligament cells on an avulsed tooth die progressively with extraoral dry time; beyond about 60 minutes of dry storage, PDL viability is severely compromised.',
      'B': 'Extraoral dry time critically determines PDL cell survival and avulsion prognosis. It fails this stem, which requires Poor PDL viability and worsened prognosis; manage per trauma guidelines: Periodontal ligament cells on an avulsed tooth die progressively with extraoral dry time; beyond about 60 minutes of dry storage, PDL viability is severely compromised.',
      'C': 'Permanent avulsion protocols differ from primary teeth, which are generally not replanted. It fails this stem, which requires Poor PDL viability and worsened prognosis; manage per trauma guidelines: Periodontal ligament cells on an avulsed tooth die progressively with extraoral dry time; beyond about 60 minutes of dry storage, PDL viability is severely compromised.',
    ...
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Scaling alone ignores a pulpal source when a true combined lesion exists. It fails this stem, which requires Addressing both endodontic and periodontal infection pathways: Combined perio-endo lesions involve communication between pulpal and periodontal infection pathways, so both niches must be disinfected for healing.',
      'C': 'Alignment does not disinfect pulpal or periodontal infection pathways. It fails this stem, which requires Addressing both endodontic and periodontal infection pathways: Combined perio-endo lesions involve communication between pulpal and periodontal infection pathways, so both niches must be disinfected for healing.',
      'D': 'Whitening does not treat perio-endo infection. It fails this stem, which requires Addressing both endodontic and periodontal infection pathways: Combined perio-endo lesions involve communication between pulpal and periodontal infection pathways, so both niches must be disinfected for healing.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Internal and external resorption differ radiographically and require different treatment. It fails this stem, which requires Radiographic and clinical patterns differ and treatment differs: Internal resorption begins within the pulp chamber or canal from inflamed pulp tissue and appears as a ballooned canal outline that moves with tube shift less than external defects.',
      'B': 'Pathologic root resorption generally progresses without appropriate intervention. It fails this stem, which requires Radiographic and clinical patterns differ and treatment differs: Internal resorption begins within the pulp chamber or canal from inflamed pulp tissue and appears as a ballooned canal outline that moves with tube shift less than external defects.',
      ...
      'D': 'Diagnosis requires imaging and vitality testing before deciding extraction. It fails this stem, which requires Radiographic and clinical patterns differ and treatment differs: Internal resorption begins within the pulp chamber or canal from inflamed pulp tissue and appears as a ballooned canal outline that moves with tube shift less than external defects.'
     }
    }
   ]
  },
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Shade matching is optical and unrelated to ferrule biomechanics. It fails this stem, which requires Fracture resistance of crowned endodontically treated teeth: A ferrule is a band of sound axial tooth structure of adequate height and thickness encircled by the crown margin.',
      'C': 'Cement color stability is a material property, not the ferrule bracing mechanism. It fails this stem, which requires Fracture resistance of crowned endodontically treated teeth: A ferrule is a band of sound axial tooth structure of adequate height and thickness encircled by the crown margin.',
      'D': 'Tray adhesive sticks impression material to trays, unrelated to ferrule effect. It fails this stem, which requires Fracture resistance of crowned endodontically treated teeth: A ferrule is a band of sound axial tooth structure of adequate height and thickness encircled by the crown margin.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'A single bounded edentulous space is Kennedy Class III, not Class I. It fails this stem, which requires Bilateral distal-extension edentulous areas: Kennedy Class I describes a bilateral edentulous area posterior to the remaining natural teeth (bilateral distal extension).',
      ...
      'C': 'An anterior bounded span is Kennedy Class IV, not Class I. It fails this stem, which requires Bilateral distal-extension edentulous areas: Kennedy Class I describes a bilateral edentulous area posterior to the remaining natural teeth (bilateral distal extension).',
      'D': 'A complete denture opposing naturals is not Kennedy classification of a partial arch. It fails this stem, which requires Bilateral distal-extension edentulous areas: Kennedy Class I describes a bilateral edentulous area posterior to the remaining natural teeth (bilateral distal extension).'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Alginate lacks accuracy/stability for most definitive cast crown impressions. It fails this stem, which requires Accurate finish-line capture with soft-tissue management: Cast restorations depend on an impression that records the finish line in undistorted detail and relates soft tissues without tears or voids.',
      'B': 'Interocclusal records relate arches but do not capture finish-line detail. It fails this stem, which requires Accurate finish-line capture with soft-tissue management: Cast restorations depend on an impression that records the finish line in undistorted detail and relates soft tissues without tears or voids.',
      ...
      'D': 'Shade photos record color and cannot replace a dimensional margin impression. It fails this stem, which requires Accurate finish-line capture with soft-tissue management: Cast restorations depend on an impression that records the finish line in undistorted detail and relates soft tissues without tears or voids.'
     }
    }
   ],
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'Biologic-width violation causes inflammation/bone loss, not improved papilla fill. It fails this stem, which requires Chronic inflammation and crestal bone loss: Supracrestal tissue attachment (biological width) is the combined junctional epithelium and connective tissue attachment coronal to alveolar crest.',
      'B': 'Margin invasion of supracrestal attachment does not beneficially accelerate orthodontics. It fails this stem, which requires Chronic inflammation and crestal bone loss: Supracrestal tissue attachment (biological width) is the combined junctional epithelium and connective tissue attachment coronal to alveolar crest.',
      'C': 'Biologic-width violation is unrelated to bleaching chemistry. It fails this stem, which requires Chronic inflammation and crestal bone loss: Supracrestal tissue attachment (biological width) is the combined junctional epithelium and connective tissue attachment coronal to alveolar crest.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Implants lack a PDL, so proprioception and mobility differ from natural teeth. It fails this stem, which requires Absence of a PDL with different mobility and feedback: Natural teeth are suspended by a periodontal ligament that provides proprioception and physiologic mobility; osseointegrated implants are ankylosed to bone without a PDL.',
      ...
      'C': 'Implants show less—not greater—physiologic mobility than PDL-suspended teeth. It fails this stem, which requires Absence of a PDL with different mobility and feedback: Natural teeth are suspended by a periodontal ligament that provides proprioception and physiologic mobility; osseointegrated implants are ankylosed to bone without a PDL.',
      'D': 'Implants do not possess a true periodontal ligament. It fails this stem, which requires Absence of a PDL with different mobility and feedback: Natural teeth are suspended by a periodontal ligament that provides proprioception and physiologic mobility; osseointegrated implants are ankylosed to bone without a PDL.'
     }
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'A conventional complete denture is delivered after healing/remodeling, not as an immediate denture. It fails this stem, which requires At the extraction appointment after prior fabrication: An immediate denture is fabricated before extractions and inserted at the same appointment the teeth are removed.',
      'C': 'Immediate dentures require examination and records before fabrication. It fails this stem, which requires At the extraction appointment after prior fabrication: An immediate denture is fabricated before extractions and inserted at the same appointment the teeth are removed.',
      'D': 'A Hawley retainer holds orthodontic alignment; it is not an immediate complete denture. It fails this stem, which requires At the extraction appointment after prior fabrication: An immediate denture is fabricated before extractions and inserted at the same appointment the teeth are removed.'
     }
    }
   ],
   'hard': [
    {
     ...
     'choice_explanations': {
      'A': 'Cantilevers increase—not reduce—lever stress on abutments versus fixed-fixed designs. It fails this stem, which requires Leverage overload and stress concentration on abutments: A cantilever fixed dental prosthesis has an abutment at only one end of the pontic, creating a class I lever under occlusal load.',
      'B': 'Cantilever leverage raises cement and abutment stress rather than lowering failure risk. It fails this stem, which requires Leverage overload and stress concentration on abutments: A cantilever fixed dental prosthesis has an abutment at only one end of the pontic, creating a class I lever under occlusal load.',
      'C': 'Cantilevers are not universally superior to single-tooth implants in survival. It fails this stem, which requires Leverage overload and stress concentration on abutments: A cantilever fixed dental prosthesis has an abutment at only one end of the pontic, creating a class I lever under occlusal load.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Cement- vs screw-retained crowns differ in cement risk, esthetics, and retrievability. It fails this stem, which requires Cement excess control versus screw-access esthetics and retrievability: Cement-retained implant crowns can offer esthetic continuity without an occlusal screw access hole, but excess subgingival cement is difficult to remove and is strongly linked to peri-implant inflammation.',
      ...
      'C': 'Subgingival cement is harder to remove and linked to peri-implant inflammation. It fails this stem, which requires Cement excess control versus screw-access esthetics and retrievability: Cement-retained implant crowns can offer esthetic continuity without an occlusal screw access hole, but excess subgingival cement is difficult to remove and is strongly linked to peri-implant inflammation.',
      'D': 'Screw-retained crowns still face screw loosening, fracture, and other complications. It fails this stem, which requires Cement excess control versus screw-access esthetics and retrievability: Cement-retained implant crowns can offer esthetic continuity without an occlusal screw access hole, but excess subgingival cement is difficult to remove and is strongly linked to peri-implant inflammation.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Shade prescription is optical and not the purpose of RPD cast surveying. It fails this stem, which requires Path of insertion and usable undercuts: Surveying orients a diagnostic cast to a chosen path of insertion and identifies soft- and hard-tissue undercuts relative to that path.',
      'B': 'Chronologic age is not determined by surveying a cast. It fails this stem, which requires Path of insertion and usable undercuts: Surveying orients a diagnostic cast to a chosen path of insertion and identifies soft- and hard-tissue undercuts relative to that path.',
      ...
      'D': 'Bite force is a physiologic measure, not obtained by surveying. It fails this stem, which requires Path of insertion and usable undercuts: Surveying orients a diagnostic cast to a chosen path of insertion and identifies soft- and hard-tissue undercuts relative to that path.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      'A': 'Skipping diagnosis/disease control undermines rehabilitation longevity. It fails this stem, which requires Disease control, VDO/occlusion planning, provisionals, then finals: Full-mouth rehabilitation fails if active caries or periodontitis undermines new restorations, so disease control comes first.',
      'B': 'Shade before disease control risks restorations on unstable foundations. It fails this stem, which requires Disease control, VDO/occlusion planning, provisionals, then finals: Full-mouth rehabilitation fails if active caries or periodontitis undermines new restorations, so disease control comes first.',
      'C': 'Extractions require consent and are not the default first step of full-mouth rehab. It fails this stem, which requires Disease control, VDO/occlusion planning, provisionals, then finals: Full-mouth rehabilitation fails if active caries or periodontitis undermines new restorations, so disease control comes first.',
    ...
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Camouflage is orthodontic compensation, not the prosthodontic combination-syndrome scenario. It fails this stem, which requires An edentulous maxilla opposing mandibular anterior natural teeth: Combination syndrome classically occurs with a complete maxillary denture opposing mandibular anterior natural teeth (often with missing posterior support).',
      'C': 'The maxillary lateral incisor is a single-rooted anterior tooth; true bony impaction is uncommon versus agenesis. It fails this stem, which requires An edentulous maxilla opposing mandibular anterior natural teeth: Combination syndrome classically occurs with a complete maxillary denture opposing mandibular anterior natural teeth (often with missing posterior support).',
      'D': 'A mesiodens is a supernumerary tooth, not combination syndrome. It fails this stem, which requires An edentulous maxilla opposing mandibular anterior natural teeth: Combination syndrome classically occurs with a complete maxillary denture opposing mandibular anterior natural teeth (often with missing posterior support).'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Forced seating induces strain in implants/bone and violates passive fit. It fails this stem, which requires The framework seats without inducing strain on implants: Passive fit means an implant framework seats on abutments without inducing tensile or compressive strain in the screws or peri-implant bone.',
      'B': 'Cement cannot safely compensate for framework distortion that strains implants. It fails this stem, which requires The framework seats without inducing strain on implants: Passive fit means an implant framework seats on abutments without inducing tensile or compressive strain in the screws or peri-implant bone.',
      ...
      'D': 'Shade is esthetic; passive mechanical fit is a separate implant-prosthetic requirement. It fails this stem, which requires The framework seats without inducing strain on implants: Passive fit means an implant framework seats on abutments without inducing tensile or compressive strain in the screws or peri-implant bone.'
     }
    }
   ]
  },
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Third molars erupt in late adolescence/early adulthood, not at age 3. It fails this stem, which requires Mandibular first molar around age 6 years: The mandibular first permanent molars typically erupt around age six and are often the first permanent teeth to appear, distal to the primary second molars.',
      'C': 'The maxillary lateral incisor is a single-rooted anterior tooth; true bony impaction is uncommon versus agenesis. It fails this stem, which requires Mandibular first molar around age 6 years: The mandibular first permanent molars typically erupt around age six and are often the first permanent teeth to appear, distal to the primary second molars.',
      'D': 'Permanent canines erupt ~11–12 years; 4 months is primary-dentition timing. It fails this stem, which requires Mandibular first molar around age 6 years: The mandibular first permanent molars typically erupt around age six and are often the first permanent teeth to appear, distal to the primary second molars.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Angle Class II is an anteroposterior molar discrepancy, not prevented by fluoride varnish. It fails this stem, which requires Dental caries: Fluoride varnish delivers a high fluoride concentration that promotes remineralization of enamel and forms calcium fluoride–like reservoirs on the tooth surface.',
      ...
      'C': 'Ankylosis is pathologic fusion of cementum to alveolar bone interrupting eruption/exfoliation. It fails this stem, which requires Dental caries: Fluoride varnish delivers a high fluoride concentration that promotes remineralization of enamel and forms calcium fluoride–like reservoirs on the tooth surface.',
      'D': 'Supernumerary teeth are developmental extras from dental lamina hyperactivity, not fluoride targets. It fails this stem, which requires Dental caries: Fluoride varnish delivers a high fluoride concentration that promotes remineralization of enamel and forms calcium fluoride–like reservoirs on the tooth surface.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Peri-implantitis is inflammatory bone loss around implants; pulpotomy is primary-tooth pulp therapy. It fails this stem, which requires A restorable primary tooth with inflamed coronal pulp and healthy radicular pulp: Pulpotomy removes inflamed coronal pulp while preserving radicular pulp vitality in a restorable primary tooth, usually after carious or traumatic exposure with healthy root pulp.',
      'B': 'Enamel etching creates microporosity for bonding; it is not an indication for pulpotomy. It fails this stem, which requires A restorable primary tooth with inflamed coronal pulp and healthy radicular pulp: Pulpotomy removes inflamed coronal pulp while preserving radicular pulp vitality in a restorable primary tooth, usually after carious or traumatic exposure with healthy root pulp.',
      ...
      'D': 'Vital bleaching oxidizes enamel/dentin chromogens and does not treat inflamed primary pulp. It fails this stem, which requires A restorable primary tooth with inflamed coronal pulp and healthy radicular pulp: Pulpotomy removes inflamed coronal pulp while preserving radicular pulp vitality in a restorable primary tooth, usually after carious or traumatic exposure with healthy root pulp.'
     }
    }
   ],
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'Shade try-in verifies ceramic color optically and is not a stainless-steel-crown indication. It fails this stem, which requires Multi-surface caries in a primary molar: Primary molars with multi-surface caries often lack sufficient tooth structure for durable intracoronal restorations and are subject to high occlusal load.',
      ...
      'C': 'Bleaching trays hold peroxide gel; they are not full-coverage primary molar restorations. It fails this stem, which requires Multi-surface caries in a primary molar: Primary molars with multi-surface caries often lack sufficient tooth structure for durable intracoronal restorations and are subject to high occlusal load.',
      'D': 'Laminate veneer prep removes facial enamel for bonded ceramics on permanent teeth. It fails this stem, which requires Multi-surface caries in a primary molar: Primary molars with multi-surface caries often lack sufficient tooth structure for durable intracoronal restorations and are subject to high occlusal load.'
     }
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Permanent third molars are not the classic primary teeth destroyed in early childhood caries. It fails this stem, which requires Maxillary primary anterior teeth: Early childhood caries classically affects maxillary primary incisors because sweetened liquids pool around them during bottle or sippy-cup use, especially at night when salivary flow is low.',
      'C': 'The maxillary canine is a long-erupting anterior tooth and the second most commonly impacted tooth. It fails this stem, which requires Maxillary primary anterior teeth: Early childhood caries classically affects maxillary primary incisors because sweetened liquids pool around them during bottle or sippy-cup use, especially at night when salivary flow is low.',
      'D': 'In classic bottle ECC, the tongue and saliva relatively protect mandibular anteriors versus maxillary ones. It fails this stem, which requires Maxillary primary anterior teeth: Early childhood caries classically affects maxillary primary incisors because sweetened liquids pool around them during bottle or sippy-cup use, especially at night when salivary flow is low.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'General anesthesia is reserved for selected cases, not first-line for a fearful but cooperative child. It fails this stem, which requires Tell-show-do communication: Tell-show-do introduces the child to instruments and sensations in a nonthreatening sequence, reducing fear through predictable communication.',
      'B': 'Protective stabilization without consent discussion is not basic first-line behavior guidance. It fails this stem, which requires Tell-show-do communication: Tell-show-do introduces the child to instruments and sensations in a nonthreatening sequence, reducing fear through predictable communication.',
      ...
      'D': 'Ignoring fear increases anxiety and does not build cooperative coping. It fails this stem, which requires Tell-show-do communication: Tell-show-do introduces the child to instruments and sensations in a nonthreatening sequence, reducing fear through predictable communication.'
     }
    }
   ],
   'hard': [
    {
     ...
     'choice_explanations': {
      'A': 'TMJ ankylosis is bony/fibrous joint fusion and is not the usual sequela of primary incisor intrusion. It fails this stem, which requires Damage to the developing permanent successor: The developing permanent successor lies in close proximity to the primary tooth root; intrusive luxation can drive the primary root against the permanent tooth germ.',
      'B': 'Freckles are melanocytic macules unrelated to intrusive luxation of primary teeth. It fails this stem, which requires Damage to the developing permanent successor: The developing permanent successor lies in close proximity to the primary tooth root; intrusive luxation can drive the primary root against the permanent tooth germ.',
      'C': 'Primary incisor intrusion does not invariably drive maxillary sinusitis. It fails this stem, which requires Damage to the developing permanent successor: The developing permanent successor lies in close proximity to the primary tooth root; intrusive luxation can drive the primary root against the permanent tooth germ.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'After primary second-molar loss, the permanent molar drifts mesially, consuming—not preserving—leeway space. It fails this stem, which requires Mesial drift of the first permanent molar: The primary second molar holds the leeway space and guides eruption of the first permanent molar.',
      ...
      'C': 'Arch length does not spontaneously increase to restore premolar space after mesial molar drift. It fails this stem, which requires Mesial drift of the first permanent molar: The primary second molar holds the leeway space and guides eruption of the first permanent molar.',
      'D': 'Space loss after early primary second-molar extraction does not automatically correct midlines. It fails this stem, which requires Mesial drift of the first permanent molar: The primary second molar holds the leeway space and guides eruption of the first permanent molar.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Tetracycline causes intrinsic banding discoloration; MIH is a separate demarcated hypomineralization entity. It fails this stem, which requires Demarcated opacities on first permanent molars and often incisors: Molar-incisor hypomineralization is a qualitative enamel defect producing demarcated opacities on first permanent molars and often incisors.',
      'B': 'Fluorosis is typically diffuse enamel opacity; MIH shows demarcated opacities on first molars/incisors. It fails this stem, which requires Demarcated opacities on first permanent molars and often incisors: Molar-incisor hypomineralization is a qualitative enamel defect producing demarcated opacities on first permanent molars and often incisors.',
      ...
      'D': 'MIH is a qualitative developmental enamel defect, not caries alone. It fails this stem, which requires Demarcated opacities on first permanent molars and often incisors: Molar-incisor hypomineralization is a qualitative enamel defect producing demarcated opacities on first permanent molars and often incisors.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Age-appropriate injuries matching a coherent history are consistent with accidental trauma. It fails this stem, which requires Injuries inconsistent with the stated history and developmental age: Injuries that do not match the stated mechanism, developmental stage, or alleged timing raise concern for non-accidental trauma.',
      'C': 'Isolated caries without trauma is not itself a non-accidental injury pattern. It fails this stem, which requires Injuries inconsistent with the stated history and developmental age: Injuries that do not match the stated mechanism, developmental stage, or alleged timing raise concern for non-accidental trauma.',
      'D': 'Crowding is a malocclusion finding, not an abuse trauma pattern. It fails this stem, which requires Injuries inconsistent with the stated history and developmental age: Injuries that do not match the stated mechanism, developmental stage, or alleged timing raise concern for non-accidental trauma.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Simple cooperative care does not meet criteria for general anesthesia. It fails this stem, which requires Extensive disease plus inability to cooperate or medical complexity after alternatives are considered: General anesthesia for dentistry is reserved when extensive treatment needs cannot be completed safely with behavioral guidance, local anesthesia, or sedation—especially with medical or developmental complexity—after.',
      'B': 'Extrinsic stain alone does not justify pediatric dental general anesthesia. It fails this stem, which requires Extensive disease plus inability to cooperate or medical complexity after alternatives are considered: General anesthesia for dentistry is reserved when extensive treatment needs cannot be completed safely with behavioral guidance, local anesthesia, or sedation—especially with medical or developmental.',
      ...
      'D': 'Scheduling preference alone is not a clinical indication for dental GA. It fails this stem, which requires Extensive disease plus inability to cooperate or medical complexity after alternatives are considered: General anesthesia for dentistry is reserved when extensive treatment needs cannot be completed safely with behavioral guidance, local anesthesia, or sedation—especially with medical or developmental complexity—after.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Primary avulsions are not managed with permanent-tooth replantation protocols. It fails this stem, which requires Not replanted, to protect the permanent successor: Replanting an avulsed primary tooth risks damage to the underlying permanent tooth germ from the primary root or from inflammatory sequelae.',
      'B': 'Extraoral RCT plus replantation risks injury to the permanent successor and is not advised for primary teeth. It fails this stem, which requires Not replanted, to protect the permanent successor: Replanting an avulsed primary tooth risks damage to the underlying permanent tooth germ from the primary root or from inflammatory sequelae.',
      'C': 'After primary avulsion, soft tissues and successor risk still require clinical examination. It fails this stem, which requires Not replanted, to protect the permanent successor: Replanting an avulsed primary tooth risks damage to the underlying permanent tooth germ from the primary root or from inflammatory sequelae.',
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Attached gingiva is keratinized mucosa and is not the usual primary site of recurrent aphthae. It fails this stem, which requires Non-keratinized movable mucosa: Recurrent aphthous ulcers arise on non-keratinized mucosa such as the buccal mucosa, floor of mouth, and ventral tongue, where the epithelium is thinner and more mobile.',
      'C': 'Hard palate is keratinized mucosa and not the classic recurrent aphthous site. It fails this stem, which requires Non-keratinized movable mucosa: Recurrent aphthous ulcers arise on non-keratinized mucosa such as the buccal mucosa, floor of mouth, and ventral tongue, where the epithelium is thinner and more mobile.',
      'D': 'Aphthae arise on non-keratinized intraoral mucosa; exclusive vermilion lesions suggest herpes labialis instead. It fails this stem, which requires Non-keratinized movable mucosa: Recurrent aphthous ulcers arise on non-keratinized mucosa such as the buccal mucosa, floor of mouth, and ventral tongue, where the epithelium is thinner and more mobile.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Wipeable white films are candidal pseudomembranes; leukoplakia cannot be wiped away. It fails this stem, which requires A white patch that cannot be wiped away or attributed to another defined disease: Oral leukoplakia is a clinical diagnosis of exclusion: a white plaque that cannot be wiped away and cannot be attributed to another defined disease such as candidiasis or lichen planus.',
      'B': 'Reticular Wickham striae indicate lichen planus, a defined disease excluded before diagnosing leukoplakia. It fails this stem, which requires A white patch that cannot be wiped away or attributed to another defined disease: Oral leukoplakia is a clinical diagnosis of exclusion: a white plaque that cannot be wiped away and cannot be attributed to another defined disease such as candidiasis or lichen planus.',
      'C': 'Linea alba is a normal frictional white line along the occlusal plane, not leukoplakia. It fails this stem, which requires A white patch that cannot be wiped away or attributed to another defined disease: Oral leukoplakia is a clinical diagnosis of exclusion: a white plaque that cannot be wiped away and cannot be attributed to another defined disease such as candidiasis or lichen planus.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Geographic tongue is benign migratory glossitis and is not carcinoma by default. It fails this stem, which requires Benign migratory glossitis: Geographic tongue (benign migratory glossitis) shows migrating areas of filiform papilla atrophy surrounded by slightly raised white borders.',
      'B': 'Syphilitic mucous patches are infectious mucosal lesions distinct from migratory glossitis. It fails this stem, which requires Benign migratory glossitis: Geographic tongue (benign migratory glossitis) shows migrating areas of filiform papilla atrophy surrounded by slightly raised white borders.',
      ...
      'D': 'Traumatic ulcers are focal injury lesions, not the migrating papillary pattern of geographic tongue. It fails this stem, which requires Benign migratory glossitis: Geographic tongue (benign migratory glossitis) shows migrating areas of filiform papilla atrophy surrounded by slightly raised white borders.'
     }
    }
   ],
   'medium': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Orthodontic wax shields mucosa from brackets and is not a major candidiasis risk cluster. It fails this stem, which requires Antibiotics, steroids, dentures, xerostomia, immunosuppression: Candida albicans is an oral commensal that overgrows when local or systemic defenses fall—broad-spectrum antibiotics, corticosteroids, denture bases, xerostomia, or immunosuppression.',
      'C': 'Flossing is mechanical hygiene and not a risk-factor set for oral candidiasis. It fails this stem, which requires Antibiotics, steroids, dentures, xerostomia, immunosuppression: Candida albicans is an oral commensal that overgrows when local or systemic defenses fall—broad-spectrum antibiotics, corticosteroids, denture bases, xerostomia, or immunosuppression.',
      'D': 'Sealants are preventive resin coatings of pits/fissures without irradiated-bone trauma. It fails this stem, which requires Antibiotics, steroids, dentures, xerostomia, immunosuppression: Candida albicans is an oral commensal that overgrows when local or systemic defenses fall—broad-spectrum antibiotics, corticosteroids, denture bases, xerostomia, or immunosuppression.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Punched-out necrotic papillae define NUG, not reticular oral lichen planus. It fails this stem, which requires Reticular white striae (Wickham striae): Oral lichen planus is a T-cell–mediated mucocutaneous disease; the reticular form shows lace-like white striae (Wickham striae), often bilaterally on the buccal mucosa.',
      ...
      'C': 'Koplik spots are measles enanthem opposite the molars, not lichen planus striae. It fails this stem, which requires Reticular white striae (Wickham striae): Oral lichen planus is a T-cell–mediated mucocutaneous disease; the reticular form shows lace-like white striae (Wickham striae), often bilaterally on the buccal mucosa.',
      'D': 'Fordyce granules are normal ectopic sebaceous glands, not lichen planus. It fails this stem, which requires Reticular white striae (Wickham striae): Oral lichen planus is a T-cell–mediated mucocutaneous disease; the reticular form shows lace-like white striae (Wickham striae), often bilaterally on the buccal mucosa.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Xylitol reduces caries risk via bacterial metabolism effects and is not an OSCC carcinogen. It fails this stem, which requires Tobacco and alcohol use: Tobacco and alcohol are synergistic carcinogens for oral squamous cell carcinoma, causing cumulative DNA damage in keratinocytes of the oral epithelium.',
      'B': 'Toothbrush modality is unrelated to oral squamous carcinoma carcinogenesis. It fails this stem, which requires Tobacco and alcohol use: Tobacco and alcohol are synergistic carcinogens for oral squamous cell carcinoma, causing cumulative DNA damage in keratinocytes of the oral epithelium.',
      ...
      'D': 'Clear aligners apply orthodontic force and are not oral carcinogens. It fails this stem, which requires Tobacco and alcohol use: Tobacco and alcohol are synergistic carcinogens for oral squamous cell carcinoma, causing cumulative DNA damage in keratinocytes of the oral epithelium.'
     }
    }
   ],
   'hard': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Fordyce granules are normal ectopic sebaceous glands, not pemphigus vulgaris. It fails this stem, which requires Flaccid bullae, positive Nikolsky sign, and desquamative gingivitis themes: Pemphigus vulgaris is an autoimmune acantholysis caused by autoantibodies against desmogleins, producing flaccid intraepithelial bullae that rupture easily (Nikolsky sign positive) and painful erosions, often with desquamative gingivitis.',
      'C': 'Torus palatinus is a benign midline palatal exostosis unrelated to plaque gingivitis. It fails this stem, which requires Flaccid bullae, positive Nikolsky sign, and desquamative gingivitis themes: Pemphigus vulgaris is an autoimmune acantholysis caused by autoantibodies against desmogleins, producing flaccid intraepithelial bullae that rupture easily (Nikolsky sign positive) and painful erosions, often with desquamative gingivitis.',
      'D': 'Amalgam tattoo is iatrogenic metal pigment in mucosa, not autoimmune acantholysis. It fails this stem, which requires Flaccid bullae, positive Nikolsky sign, and desquamative gingivitis themes: Pemphigus vulgaris is an autoimmune acantholysis caused by autoantibodies against desmogleins, producing flaccid intraepithelial bullae that rupture easily (Nikolsky sign positive) and painful erosions, often with desquamative gingivitis.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Sjögren syndrome causes hyposalivation and increased—not reduced—caries risk. It fails this stem, which requires Autoimmune exocrinopathy with elevated caries risk: Sjögren syndrome is an autoimmune destruction of exocrine glands that markedly reduces salivary flow.',
      ...
      'C': 'Dens evaginatus is an occlusal enamel tubercle that can pulp-expose with wear/fracture. It fails this stem, which requires Autoimmune exocrinopathy with elevated caries risk: Sjögren syndrome is an autoimmune destruction of exocrine glands that markedly reduces salivary flow.',
      'D': 'A mesiodens is a supernumerary midline tooth unrelated to autoimmune exocrinopathy. It fails this stem, which requires Autoimmune exocrinopathy with elevated caries risk: Sjögren syndrome is an autoimmune destruction of exocrine glands that markedly reduces salivary flow.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'OKCs are notable for high—not low—recurrence after incomplete removal. It fails this stem, which requires High recurrence potential requiring careful surgical management: The odontogenic keratocyst arises from dental lamina rests and is lined by parakeratinized stratified squamous epithelium with high proliferative activity.',
      'B': 'OKCs are locally aggressive cystic lesions generally requiring surgical management. It fails this stem, which requires High recurrence potential requiring careful surgical management: The odontogenic keratocyst arises from dental lamina rests and is lined by parakeratinized stratified squamous epithelium with high proliferative activity.',
      ...
      'D': 'OKC is a cystic jaw lesion of dental lamina rests, not a pulpitis diagnosis. It fails this stem, which requires High recurrence potential requiring careful surgical management: The odontogenic keratocyst arises from dental lamina rests and is lined by parakeratinized stratified squamous epithelium with high proliferative activity.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Persistent solitary high-risk ulcers require tissue diagnosis, not indefinite aphthous labeling. It fails this stem, which requires Cancer until proven otherwise — biopsy: A solitary oral ulcer lasting longer than two weeks—especially in a smoker or heavy drinker—must be regarded as squamous cell carcinoma until histologically excluded.',
      'C': 'Ignoring a chronic ulcer in a smoker delays potential carcinoma diagnosis. It fails this stem, which requires Cancer until proven otherwise — biopsy: A solitary oral ulcer lasting longer than two weeks—especially in a smoker or heavy drinker—must be regarded as squamous cell carcinoma until histologically excluded.',
      'D': 'Nutritional deficiency may ulcerate mucosa but cannot exclude carcinoma without histology when risk is high. It fails this stem, which requires Cancer until proven otherwise — biopsy: A solitary oral ulcer lasting longer than two weeks—especially in a smoker or heavy drinker—must be regarded as squamous cell carcinoma until histologically excluded.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Geographic tongue is benign migratory glossitis with migrating filiform-papilla atrophy. It fails this stem, which requires Exposed necrotic jawbone with antiresorptive drug history: MRONJ presents as exposed necrotic jawbone persisting in a patient treated with antiresorptive or antiangiogenic medications, without radiotherapy to the jaws.',
      ...
      'C': 'Aphthae are painful mucosal ulcers, not exposed necrotic jawbone of MRONJ. It fails this stem, which requires Exposed necrotic jawbone with antiresorptive drug history: MRONJ presents as exposed necrotic jawbone persisting in a patient treated with antiresorptive or antiangiogenic medications, without radiotherapy to the jaws.',
      'D': 'Occlusal caries is bacterial demineralization of tooth structure, not MRONJ. It fails this stem, which requires Exposed necrotic jawbone with antiresorptive drug history: MRONJ presents as exposed necrotic jawbone persisting in a patient treated with antiresorptive or antiangiogenic medications, without radiotherapy to the jaws.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'HPV+ oropharyngeal carcinoma has distinct tonsil/base-of-tongue epidemiology versus classic smoker floor-of-mouth SCC. It fails this stem, which requires Tonsillar crypts and base of tongue, sometimes in younger patients with less tobacco history: High-risk HPV (notably HPV-16) drives a rising subset of oropharyngeal squamous carcinomas of the tonsillar crypts and base of tongue, often in patients without traditional heavy.',
      'B': 'Cutaneous melanoma is a skin melanocyte malignancy, not HPV-driven oropharyngeal carcinoma. It fails this stem, which requires Tonsillar crypts and base of tongue, sometimes in younger patients with less tobacco history: High-risk HPV (notably HPV-16) drives a rising subset of oropharyngeal squamous carcinomas of the tonsillar crypts and base of tongue, often in patients without traditional heavy tobacco exposure.',
      'C': 'Primary molar caries is unrelated to HPV-related oropharyngeal carcinogenesis. It fails this stem, which requires Tonsillar crypts and base of tongue, sometimes in younger patients with less tobacco history: High-risk HPV (notably HPV-16) drives a rising subset of oropharyngeal squamous carcinomas of the tonsillar crypts and base of tongue, often in patients without traditional heavy tobacco exposure.',
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Anterior pit/fissure lesions are not G.V. Black Class II; Class II is proximal posterior surfaces. It fails this stem, which requires Proximal surfaces of posterior teeth: G.V.',
      'C': 'Class V lesions occupy gingival-third smooth surfaces, not proximal posterior Class II sites. It fails this stem, which requires Proximal surfaces of posterior teeth: G.V.',
      'D': 'Isolated cusp-tip enamel involvement is not the Class II proximal posterior definition. It fails this stem, which requires Proximal surfaces of posterior teeth: G.V.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Zinc phosphate lutes by mechanical interlocking as a cement, not etch-adhesive micromechanical bonding of composite. It fails this stem, which requires Micromechanical adhesion after etch and adhesive protocols: Etching enamel (and appropriately conditioning dentin) creates microporosity that adhesive resins infiltrate to form resin tags and a hybrid layer.',
      'B': 'Sutures approximate soft tissue and do not retain composite to etched tooth structure. It fails this stem, which requires Micromechanical adhesion after etch and adhesive protocols: Etching enamel (and appropriately conditioning dentin) creates microporosity that adhesive resins infiltrate to form resin tags and a hybrid layer.',
      'C': 'Composite is retained by adhesive micromechanical interlocking, not dentin screws. It fails this stem, which requires Micromechanical adhesion after etch and adhesive protocols: Etching enamel (and appropriately conditioning dentin) creates microporosity that adhesive resins infiltrate to form resin tags and a hybrid layer.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Caries detector dyes aid excavation visualization and cannot replace radiographic diagnosis. It fails this stem, which requires Help visualize infected dentin, interpreted cautiously: Caries detector dyes bind preferentially to denatured collagen in infected dentin, helping visualize tissue that may harbor high bacterial load.',
      'B': 'Pulp vitality requires thermal/electric testing; dyes do not diagnose pulp status. It fails this stem, which requires Help visualize infected dentin, interpreted cautiously: Caries detector dyes bind preferentially to denatured collagen in infected dentin, helping visualize tissue that may harbor high bacterial load.',
      ...
      'D': 'Whitening oxidizes chromogens; caries detector dyes are diagnostic stains, not bleaches. It fails this stem, which requires Help visualize infected dentin, interpreted cautiously: Caries detector dyes bind preferentially to denatured collagen in infected dentin, helping visualize tissue that may harbor high bacterial load.'
     }
    }
   ],
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'Liners/bases protect deep dentin/pulp; they are not primarily shade modifiers. It fails this stem, which requires Protect the pulp, provide insulation, and aid sealing: Liners and bases under deep restorations provide thermal insulation, chemical protection, and sometimes a sealing or bioactive interface over remaining dentin near the pulp.',
      'B': 'Liners/bases do not increase enamel etch aggressiveness; they protect remaining dentin. It fails this stem, which requires Protect the pulp, provide insulation, and aid sealing: Liners and bases under deep restorations provide thermal insulation, chemical protection, and sometimes a sealing or bioactive interface over remaining dentin near the pulp.',
      'C': 'Rubber dam isolates the tooth from saliva/microbes and protects the airway during RCT. It fails this stem, which requires Protect the pulp, provide insulation, and aid sealing: Liners and bases under deep restorations provide thermal insulation, chemical protection, and sometimes a sealing or bioactive interface over remaining dentin near the pulp.',
    ...
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Amalgam is metallic and esthetically inferior to ceramic restorations. It fails this stem, which requires Wear resistance and lower moisture sensitivity than composite: Dental amalgam’s metallic microstructure confers high compressive strength and wear resistance under posterior occlusal load.',
      'C': 'Amalgam is retained mainly by preparation form, not etch-and-rinse micromechanical bonding. It fails this stem, which requires Wear resistance and lower moisture sensitivity than composite: Dental amalgam’s metallic microstructure confers high compressive strength and wear resistance under posterior occlusal load.',
      'D': 'Amalgam undergoes oral corrosion; corrosion products can help seal margins. It fails this stem, which requires Wear resistance and lower moisture sensitivity than composite: Dental amalgam’s metallic microstructure confers high compressive strength and wear resistance under posterior occlusal load.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Secondary caries occurs at restoration margins, not remote intact pulp horns. It fails this stem, which requires Restoration margins with microleakage or plaque stagnation: Secondary (recurrent) caries develops at restoration margins where microleakage or plaque stagnation allows demineralization of adjacent enamel and dentin.',
      ...
      'C': 'Apical rarefaction relates to pulp disease pathways, not secondary coronal-margin caries. It fails this stem, which requires Restoration margins with microleakage or plaque stagnation: Secondary (recurrent) caries develops at restoration margins where microleakage or plaque stagnation allows demineralization of adjacent enamel and dentin.',
      'D': 'Cementum distant from margins is not the typical secondary caries site. It fails this stem, which requires Restoration margins with microleakage or plaque stagnation: Secondary (recurrent) caries develops at restoration margins where microleakage or plaque stagnation allows demineralization of adjacent enamel and dentin.'
     }
    }
   ],
   'hard': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Many unbonded surfaces lower C-factor and allow polymerization-shrinkage stress relief. It fails this stem, which requires Class I deep boxy preparations: The C-factor is the ratio of bonded to unbonded surfaces in a cavity; Class I boxy preparations have many bonded walls and few free surfaces for stress relief.',
      'C': 'Veneers have low bonded-to-unbonded ratios and thus lower C-factor than boxy Class I cavities. It fails this stem, which requires Class I deep boxy preparations: The C-factor is the ratio of bonded to unbonded surfaces in a cavity; Class I boxy preparations have many bonded walls and few free surfaces for stress relief.',
      'D': 'Sealants bond limited fissure enamel with low C-factor relative to deep Class I boxes. It fails this stem, which requires Class I deep boxy preparations: The C-factor is the ratio of bonded to unbonded surfaces in a cavity; Class I boxy preparations have many bonded walls and few free surfaces for stress relief.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Selective caries removal aims to avoid pulp exposure, not create it. It fails this stem, which requires Avoid pulp exposure while sealing remaining soft dentin under protocol: In deep carious lesions, selective (partial) caries removal leaves soft, caries-affected dentin over the pulp to avoid exposure while excavating peripheral infected dentin to a hard, sealable margin.',
      ...
      'C': 'Peripheral enamel/dentin at the DEJ must still be cleared to a hard, sealable margin. It fails this stem, which requires Avoid pulp exposure while sealing remaining soft dentin under protocol: In deep carious lesions, selective (partial) caries removal leaves soft, caries-affected dentin over the pulp to avoid exposure while excavating peripheral infected dentin to a hard, sealable margin.',
      'D': 'After selective excavation, a sealed restoration is placed; definitive sealing is not deferred forever. It fails this stem, which requires Avoid pulp exposure while sealing remaining soft dentin under protocol: In deep carious lesions, selective (partial) caries removal leaves soft, caries-affected dentin over the pulp to avoid exposure while excavating peripheral infected dentin to a hard, sealable margin.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Erosion is chemical dissolution by acids; abfraction specifically hypothesizes occlusal cervical stress. It fails this stem, which requires Occlusal stress contributing to cervical non-carious lesions (debated): Abfraction proposes that occlusal stress concentrates tensile strain at the cervical region, disrupting enamel and dentin and contributing to non-carious cervical lesions.',
      'B': 'Abrasion is mechanical wear; abfraction is the debated occlusal-stress contribution to NCCLs. It fails this stem, which requires Occlusal stress contributing to cervical non-carious lesions (debated): Abfraction proposes that occlusal stress concentrates tensile strain at the cervical region, disrupting enamel and dentin and contributing to non-carious cervical lesions.',
      ...
      'D': 'Pit caries is bacterial demineralization, not the abfraction stress hypothesis. It fails this stem, which requires Occlusal stress contributing to cervical non-carious lesions (debated): Abfraction proposes that occlusal stress concentrates tensile strain at the cervical region, disrupting enamel and dentin and contributing to non-carious cervical lesions.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Crowns for mere stain violate tissue-preserving minimally invasive principles. It fails this stem, which requires Prevention, early detection, and maximal tissue preservation: Minimally invasive dentistry aims to prevent disease, detect lesions early, and restore only what is irreversibly lost while preserving sound tooth structure.',
      'C': 'Extraction is not first-line for early, restorable lesions in minimally invasive dentistry. It fails this stem, which requires Prevention, early detection, and maximal tissue preservation: Minimally invasive dentistry aims to prevent disease, detect lesions early, and restore only what is irreversibly lost while preserving sound tooth structure.',
      'D': 'Minimally invasive care continues risk-factor management after restoration to prevent recurrence. It fails this stem, which requires Prevention, early detection, and maximal tissue preservation: Minimally invasive dentistry aims to prevent disease, detect lesions early, and restore only what is irreversibly lost while preserving sound tooth structure.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Biomimetic concepts select materials by mechanical compatibility with tooth tissues, not lowest cost alone. It fails this stem, which requires Replacing lost tissue with materials that mimic properties and stress distribution: Biomimetic restorative dentistry seeks to replace enamel and dentin with materials and adhesive techniques that approximate the stiffness, bonding, and stress distribution of natural tooth tissues.',
      'B': 'Single-shade convenience is not the biomimetic principle of matching stiffness and stress distribution. It fails this stem, which requires Replacing lost tissue with materials that mimic properties and stress distribution: Biomimetic restorative dentistry seeks to replace enamel and dentin with materials and adhesive techniques that approximate the stiffness, bonding, and stress distribution of natural tooth tissues.',
      ...
      'D': 'Ignoring remaining tooth structure contradicts biomimetic preservation of natural biomechanics. It fails this stem, which requires Replacing lost tissue with materials that mimic properties and stress distribution: Biomimetic restorative dentistry seeks to replace enamel and dentin with materials and adhesive techniques that approximate the stiffness, bonding, and stress distribution of natural tooth tissues.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Placing veneers before caries control invites rapid failure at new margins under high disease activity. It fails this stem, which requires Urgencies and disease control, then temporaries, then definitive care when stable: Rampant caries reflects high caries activity; placing definitive complex restorations before disease control invites rapid failure at new margins.',
      'B': 'Bleaching before excavating rampant caries does not control disease activity. It fails this stem, which requires Urgencies and disease control, then temporaries, then definitive care when stable: Rampant caries reflects high caries activity; placing definitive complex restorations before disease control invites rapid failure at new margins.',
      'C': 'Ignoring diet and saliva leaves the etiologic drivers of rampant caries unchecked. It fails this stem, which requires Urgencies and disease control, then temporaries, then definitive care when stable: Rampant caries reflects high caries activity; placing definitive complex restorations before disease control invites rapid failure at new margins.',
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Articular disc position requires soft-tissue imaging such as MRI, not bitewing radiography. It fails this stem, which requires Interproximal caries and crestal alveolar bone: Bitewing radiographs project the crowns of opposing maxillary and mandibular teeth and the crestal alveolar bone with minimal overlap when angulation is correct.',
      'C': 'Sinus polyps are not the primary indication for dental bitewing radiographs. It fails this stem, which requires Interproximal caries and crestal alveolar bone: Bitewing radiographs project the crowns of opposing maxillary and mandibular teeth and the crestal alveolar bone with minimal overlap when angulation is correct.',
      'D': 'Neck cancer staging requires advanced medical imaging, not dental bitewings. It fails this stem, which requires Interproximal caries and crestal alveolar bone: Bitewing radiographs project the crowns of opposing maxillary and mandibular teeth and the crestal alveolar bone with minimal overlap when angulation is correct.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'ALARA still permits justified radiographs; it does not ban all imaging. It fails this stem, which requires As Low As Reasonably Achievable radiation dose: ALARA (As Low As Reasonably Achievable) is the radiation-protection principle that every exposure must be justified by diagnostic benefit and then optimized to the lowest dose that still yields adequate image quality.',
      ...
      'C': 'ALARA applies to all receptors, including digital sensors. It fails this stem, which requires As Low As Reasonably Achievable radiation dose: ALARA (As Low As Reasonably Achievable) is the radiation-protection principle that every exposure must be justified by diagnostic benefit and then optimized to the lowest dose that still yields adequate image quality.',
      'D': 'Routine CBCT violates dose optimization when two-dimensional imaging suffices. It fails this stem, which requires As Low As Reasonably Achievable radiation dose: ALARA (As Low As Reasonably Achievable) is the radiation-protection principle that every exposure must be justified by diagnostic benefit and then optimized to the lowest dose that still yields adequate image quality.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Bitewings show crown contacts; periapicals are intended for full tooth length and periapical bone. It fails this stem, which requires The full tooth length and periapical bone: A periapical radiograph images the entire tooth from crown to apex plus the surrounding periapical bone.',
      'B': 'Cephalometric films provide skeletal landmarks; periapicals image individual teeth/apices. It fails this stem, which requires The full tooth length and periapical bone: A periapical radiograph images the entire tooth from crown to apex plus the surrounding periapical bone.',
      'C': 'Dental periapical films image teeth and jaws, not thoracic chest structures. It fails this stem, which requires The full tooth length and periapical bone: A periapical radiograph images the entire tooth from crown to apex plus the surrounding periapical bone.',
   ...
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'Panoramics have lower spatial resolution than bitewings for early interproximal enamel caries. It fails this stem, which requires A broad overview of jaws, TMJs, and dentition: A panoramic radiograph captures both jaws, dentition, TMJs, and contiguous structures in a single tomographic image.',
      ...
      'C': 'Panoramic geometry produces inherent distortion and ghosting; distortion is not absent. It fails this stem, which requires A broad overview of jaws, TMJs, and dentition: A panoramic radiograph captures both jaws, dentition, TMJs, and contiguous structures in a single tomographic image.',
      'D': 'Panoramics complement but do not eliminate indicated high-detail periapical radiographs. It fails this stem, which requires A broad overview of jaws, TMJs, and dentition: A panoramic radiograph captures both jaws, dentition, TMJs, and contiguous structures in a single tomographic image.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Not every apical radiolucency is osteosarcoma; most are inflammatory rarefying osteitis from necrosis. It fails this stem, which requires Periapical rarefying osteitis (granuloma/cyst/abscess spectrum): Bacterial toxins from a necrotic pulp trigger inflammatory resorption of periapical bone, producing a radiolucency (rarefying osteitis) that may represent granuloma, cyst, or abscess histologically.',
      'B': 'Mandibular tori are radiopaque bony exostoses, not apical radiolucencies. It fails this stem, which requires Periapical rarefying osteitis (granuloma/cyst/abscess spectrum): Bacterial toxins from a necrotic pulp trigger inflammatory resorption of periapical bone, producing a radiolucency (rarefying osteitis) that may represent granuloma, cyst, or abscess histologically.',
      ...
      'D': 'Enamel pearls are ectopic enamel droplets on root surfaces, often near furcations. It fails this stem, which requires Periapical rarefying osteitis (granuloma/cyst/abscess spectrum): Bacterial toxins from a necrotic pulp trigger inflammatory resorption of periapical bone, producing a radiolucency (rarefying osteitis) that may represent granuloma, cyst, or abscess histologically.'
     }
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Blanket omission of all shielding is not the guideline approach; use follows current recommendations. It fails this stem, which requires Current guidelines with justification of exposure first: Lead aprons and thyroid shields reduce exposure of radiosensitive tissues when they do not obscure anatomy, but justification of the radiograph and optimized technique remain primary.',
      'C': 'Shielding decisions apply across modalities per guidelines, not CBCT-only. It fails this stem, which requires Current guidelines with justification of exposure first: Lead aprons and thyroid shields reduce exposure of radiosensitive tissues when they do not obscure anatomy, but justification of the radiograph and optimized technique remain primary.',
      'D': 'Patient dose protection is central; protecting only operators is incomplete. It fails this stem, which requires Current guidelines with justification of exposure first: Lead aprons and thyroid shields reduce exposure of radiosensitive tissues when they do not obscure anatomy, but justification of the radiograph and optimized technique remain primary.'
     }
    }
   ],
   'hard': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'CBCT is not a routine recall substitute for bitewings because of higher effective dose. It fails this stem, which requires Complex implant, impacted tooth, or endodontic anatomy needs 3D detail beyond 2D: Cone-beam CT provides three-dimensional detail of teeth, bone, and anatomic relationships when two-dimensional images cannot answer the clinical question—for example complex implant sites, impacted teeth near nerves, or.',
      'C': 'Early interproximal enamel caries is better detected with bitewings than CBCT screening. It fails this stem, which requires Complex implant, impacted tooth, or endodontic anatomy needs 3D detail beyond 2D: Cone-beam CT provides three-dimensional detail of teeth, bone, and anatomic relationships when two-dimensional images cannot answer the clinical question—for example complex implant sites, impacted teeth near nerves, or.',
      'D': 'Shade selection is clinical/optical and is not a CBCT indication. It fails this stem, which requires Complex implant, impacted tooth, or endodontic anatomy needs 3D detail beyond 2D: Cone-beam CT provides three-dimensional detail of teeth, bone, and anatomic relationships when two-dimensional images cannot answer the clinical question—for example complex implant sites, impacted teeth near nerves, or intricate endodontic.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'A panoramic ghost image is a geometric artifact, not a biopsy-requiring lesion. It fails this stem, which requires A blurred contralateral projection of a dense object: On panoramic imaging, dense objects on one side of the jaw can cast a blurred, magnified “ghost” image on the contralateral side, projected higher and more posteriorly because of the rotational geometry.',
      ...
      'C': 'Ghost images are geometric projections from rotational panoramic geometry, including digital systems. It fails this stem, which requires A blurred contralateral projection of a dense object: On panoramic imaging, dense objects on one side of the jaw can cast a blurred, magnified “ghost” image on the contralateral side, projected higher and more posteriorly because of the rotational geometry.',
      'D': 'Mount labels are external identifiers, not radiographic ghost projections. It fails this stem, which requires A blurred contralateral projection of a dense object: On panoramic imaging, dense objects on one side of the jaw can cast a blurred, magnified “ghost” image on the contralateral side, projected higher and more posteriorly because of the rotational geometry.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'The SLOB rule localizes objects buccolingually; it is not an exposure-time chart. It fails this stem, which requires Buccolingual localization using tube-shift radiographs: The SLOB rule (Same Lingual, Opposite Buccal) uses a horizontal tube shift between two periapical radiographs to localize an object buccolingually.',
      'B': 'kVp selection is exposure technique, not the SLOB tube-shift localization rule. It fails this stem, which requires Buccolingual localization using tube-shift radiographs: The SLOB rule (Same Lingual, Opposite Buccal) uses a horizontal tube shift between two periapical radiographs to localize an object buccolingually.',
      ...
      'D': 'Processing schedules are darkroom maintenance, unrelated to SLOB localization. It fails this stem, which requires Buccolingual localization using tube-shift radiographs: The SLOB rule (Same Lingual, Opposite Buccal) uses a horizontal tube shift between two periapical radiographs to localize an object buccolingually.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Well-corticated slow expansion suggests benign cysts/tumors more than malignancy. It fails this stem, which requires Ill-defined borders, cortical destruction, and rapid change: Malignant jaw lesions often destroy bone with ill-defined, non-corticated borders and cortical perforation because neoplastic growth outpaces host bone remodeling.',
      'C': 'Tori are benign radiopaque exostoses, not malignant destructive bone patterns. It fails this stem, which requires Ill-defined borders, cortical destruction, and rapid change: Malignant jaw lesions often destroy bone with ill-defined, non-corticated borders and cortical perforation because neoplastic growth outpaces host bone remodeling.',
      'D': 'Normal trabeculae argue against an aggressive malignant jaw lesion. It fails this stem, which requires Ill-defined borders, cortical destruction, and rapid change: Malignant jaw lesions often destroy bone with ill-defined, non-corticated borders and cortical perforation because neoplastic growth outpaces host bone remodeling.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Well-collimated bitewings generally have lower—not higher—effective dose than typical CBCT fields. It fails this stem, which requires CBCT generally greater than panoramic, which is generally greater than intraoral: Effective dose generally increases from well-collimated intraoral radiographs to panoramic imaging to CBCT examinations of larger fields of view, though exact values depend on exposure parameters.',
      'B': 'Effective doses are not equal across intraoral, panoramic, and CBCT modalities. It fails this stem, which requires CBCT generally greater than panoramic, which is generally greater than intraoral: Effective dose generally increases from well-collimated intraoral radiographs to panoramic imaging to CBCT examinations of larger fields of view, though exact values depend on exposure parameters.',
      ...
      'D': 'Clinical photography uses visible light with no ionizing dose, unlike CBCT. It fails this stem, which requires CBCT generally greater than panoramic, which is generally greater than intraoral: Effective dose generally increases from well-collimated intraoral radiographs to panoramic imaging to CBCT examinations of larger fields of view, though exact values depend on exposure parameters.'
     }
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'RCT treats pulp/periapical disease; idiopathic osteosclerosis by a vital tooth needs no endodontics. It fails this stem, which requires Tooth vitality testing and clinical inflammatory context: Idiopathic osteosclerosis is a focal radiopacity in bone associated with a vital tooth and no inflammatory cause.',
      'C': 'Neither idiopathic osteosclerosis nor condensing osteitis is managed as malignancy by default. It fails this stem, which requires Tooth vitality testing and clinical inflammatory context: Idiopathic osteosclerosis is a focal radiopacity in bone associated with a vital tooth and no inflammatory cause.',
      'D': 'Extraction is not indicated for every focal radiopacity without diagnosis. It fails this stem, which requires Tooth vitality testing and clinical inflammatory context: Idiopathic osteosclerosis is a focal radiopacity in bone associated with a vital tooth and no inflammatory cause.'
     }
    }
   ]
  },
   ...
   'easy': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Twenty is the normal primary dentition total, not the complete permanent dentition including third molars. It fails this stem, which requires 32: The permanent dentition normally comprises 8 incisors, 4 canines, 8 premolars, and 12 molars, totaling 32 teeth including third molars.',
      'C': 'Counting 28 while including third molars is inconsistent; with thirds the normal permanent total is 32. It fails this stem, which requires 32: The permanent dentition normally comprises 8 incisors, 4 canines, 8 premolars, and 12 molars, totaling 32 teeth including third molars.',
      'D': 'Sixteen teeth would represent only one arch or severe hypodontia, not the normal permanent total. It fails this stem, which requires 32: The permanent dentition normally comprises 8 incisors, 4 canines, 8 premolars, and 12 molars, totaling 32 teeth including third molars.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Thirty-two is the normal permanent dentition total including third molars, not the primary dentition. It fails this stem, which requires 20: The primary dentition consists of 8 incisors, 4 canines, and 8 molars—20 teeth total—with no premolars.',
      ...
      'C': 'Twelve is not the complete primary dentition count of 20. It fails this stem, which requires 20: The primary dentition consists of 8 incisors, 4 canines, and 8 molars—20 teeth total—with no premolars.',
      'D': 'Thirty-six exceeds the normal primary complement of 20 teeth. It fails this stem, which requires 20: The primary dentition consists of 8 incisors, 4 canines, and 8 molars—20 teeth total—with no premolars.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Mandibular central incisors lack a cusp of Carabelli, which is a maxillary first-molar trait. It fails this stem, which requires Maxillary first molar: The cusp of Carabelli is an accessory cusp or tubercle on the mesiolingual surface of the maxillary first permanent molar (and sometimes the primary second molar).',
      'B': 'The maxillary lateral incisor is a single-rooted anterior tooth; true bony impaction is uncommon versus agenesis. It fails this stem, which requires Maxillary first molar: The cusp of Carabelli is an accessory cusp or tubercle on the mesiolingual surface of the maxillary first permanent molar (and sometimes the primary second molar).',
      'C': 'Mandibular canines do not bear a cusp of Carabelli. It fails this stem, which requires Maxillary first molar: The cusp of Carabelli is an accessory cusp or tubercle on the mesiolingual surface of the maxillary first permanent molar (and sometimes the primary second molar).',
   ...
   'medium': [
    {
     ...
     'choice_explanations': {
      'A': 'Maxillary first premolars commonly have two canals, not a single canal in every specimen. It fails this stem, which requires Two roots and commonly two canals: The maxillary first premolar most often has two roots—one buccal and one palatal—and correspondingly two root canals.',
      'B': 'Maxillary first premolars are not typically three-rooted like maxillary molars. It fails this stem, which requires Two roots and commonly two canals: The maxillary first premolar most often has two roots—one buccal and one palatal—and correspondingly two root canals.',
      'C': 'Premolars are bicuspids with occlusal cusps. It fails this stem, which requires Two roots and commonly two canals: The maxillary first premolar most often has two roots—one buccal and one palatal—and correspondingly two root canals.',
    ...
    },
    {
     ...
     'choice_explanations': {
      'A': 'Anterior proximal contacts are not normally confined to the cervical third. It fails this stem, which requires Near the junction of the incisal and middle thirds: Proximal contact areas of anterior teeth are typically located in the incisal third, near the junction with the middle third, creating a contact that stabilizes the arch and protects the interdental papilla from food impaction.',
      ...
      'C': 'Proximal contacts are coronal crown features, not located at the root apex. It fails this stem, which requires Near the junction of the incisal and middle thirds: Proximal contact areas of anterior teeth are typically located in the incisal third, near the junction with the middle third, creating a contact that stabilizes the arch and protects the interdental papilla from food impaction.',
      'D': 'Healthy arches have proximal contacts that stabilize teeth and protect papillae. It fails this stem, which requires Near the junction of the incisal and middle thirds: Proximal contact areas of anterior teeth are typically located in the incisal third, near the junction with the middle third, creating a contact that stabilizes the arch and protects the interdental papilla from food impaction.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'The curve of Wilson is mediolateral; the curve of Spee is anteroposterior in the sagittal plane. It fails this stem, which requires The anteroposterior occlusal curvature in the sagittal plane: The curve of Spee is the anteroposterior occlusal curvature seen in the sagittal plane, concave superiorly in the mandibular arch from canine through posterior teeth.',
      'B': 'Bonwill’s triangle relates intercondylar and incisal distances, not the curve of Spee itself. It fails this stem, which requires The anteroposterior occlusal curvature in the sagittal plane: The curve of Spee is the anteroposterior occlusal curvature seen in the sagittal plane, concave superiorly in the mandibular arch from canine through posterior teeth.',
      ...
      'D': 'Freeway space is the interocclusal rest gap, not the anteroposterior curve of Spee. It fails this stem, which requires The anteroposterior occlusal curvature in the sagittal plane: The curve of Spee is the anteroposterior occlusal curvature seen in the sagittal plane, concave superiorly in the mandibular arch from canine through posterior teeth.'
     }
    }
   ],
   'hard': [
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Mandibular first molars rarely have only one canal per root in virtually all teeth. It fails this stem, which requires Often three canals (MB, ML, and distal) with anatomic variations: Mandibular first molars most commonly have two roots with three principal canals: mesiobuccal, mesiolingual, and a distal canal (which may split into two).',
      'C': 'Carabelli refers to a molar cusp accessory, not a five-canal naming system. It fails this stem, which requires Often three canals (MB, ML, and distal) with anatomic variations: Mandibular first molars most commonly have two roots with three principal canals: mesiobuccal, mesiolingual, and a distal canal (which may split into two).',
      'D': 'Mature mandibular molars retain a pulp chamber, though reduced by secondary dentin. It fails this stem, which requires Often three canals (MB, ML, and distal) with anatomic variations: Mandibular first molars most commonly have two roots with three principal canals: mesiobuccal, mesiolingual, and a distal canal (which may split into two).'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Enamel is thinnest toward the CEJ, not thickest there. It fails this stem, which requires Occlusal and incisal contact areas (cusp tips/incisal edges): Enamel reaches its greatest thickness over cusp tips and incisal edges—the functional contact areas that sustain heavy occlusal load—while thinning toward the cervix.',
      ...
      'C': 'The root apex is covered by cementum, not by maximal enamel thickness. It fails this stem, which requires Occlusal and incisal contact areas (cusp tips/incisal edges): Enamel reaches its greatest thickness over cusp tips and incisal edges—the functional contact areas that sustain heavy occlusal load—while thinning toward the cervix.',
      'D': 'Furcation entrances are root surfaces without thick enamel caps. It fails this stem, which requires Occlusal and incisal contact areas (cusp tips/incisal edges): Enamel reaches its greatest thickness over cusp tips and incisal edges—the functional contact areas that sustain heavy occlusal load—while thinning toward the cervix.'
     }
    },
    {
     ...
     'choice_explanations': {
      ...
      'B': 'Shade tabs are optical color references unrelated to pulp-horn height risk. It fails this stem, which requires Increased risk of pulp exposure during cavity preparation: Pulp horns extend occlusally under cusps and are relatively high in young teeth before secondary dentin accumulates.',
      'C': 'Crown/root ratios vary by tooth type; pulp-horn height is a separate anatomic risk. It fails this stem, which requires Increased risk of pulp exposure during cavity preparation: Pulp horns extend occlusally under cusps and are relatively high in young teeth before secondary dentin accumulates.',
      'D': 'Calculus volume is not determined by pulp-horn height. It fails this stem, which requires Increased risk of pulp exposure during cavity preparation: Pulp horns extend occlusally under cusps and are relatively high in young teeth before secondary dentin accumulates.'
     }
    }
   ],
   'extreme': [
    {
     ...
     'choice_explanations': {
      'A': 'Dens invaginatus creates a bacterial pathway toward the pulp, raising—not lowering—infection risk. It fails this stem, which requires Pulp infection via the invagination channel: Dens invaginatus is an infolding of the enamel organ into the dental papilla, creating a deep palatal pit continuous with a blind or open channel toward the pulp.',
      'B': 'Facial freckling is melanocytic pigmentation unrelated to ectopic canine mechanics. It fails this stem, which requires Pulp infection via the invagination channel: Dens invaginatus is an infolding of the enamel organ into the dental papilla, creating a deep palatal pit continuous with a blind or open channel toward the pulp.',
      ...
      'D': 'Mandibular tori are bony exostoses unrelated to dens invaginatus. It fails this stem, which requires Pulp infection via the invagination channel: Dens invaginatus is an infolding of the enamel organ into the dental papilla, creating a deep palatal pit continuous with a blind or open channel toward the pulp.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Taurodontism is defined by enlarged chamber and apical furcation shift, not simply dilacerated crowns. It fails this stem, which requires An enlarged pulp chamber with apically displaced furcation: Taurodontism features an enlarged pulp chamber with apical displacement of the root furcation, producing short roots relative to crown–body height.',
      ...
      'C': 'Dens evaginatus is an occlusal enamel tubercle that can pulp-expose with wear/fracture. It fails this stem, which requires An enlarged pulp chamber with apically displaced furcation: Taurodontism features an enlarged pulp chamber with apical displacement of the root furcation, producing short roots relative to crown–body height.',
      'D': 'Enamel pearls are ectopic enamel droplets on root surfaces, often near furcations. It fails this stem, which requires An enlarged pulp chamber with apically displaced furcation: Taurodontism features an enlarged pulp chamber with apical displacement of the root furcation, producing short roots relative to crown–body height.'
     }
    },
    {
     ...
     'choice_explanations': {
      'A': 'Root dilaceration complicates extraction path and endodontic access, not shade selection. It fails this stem, which requires Extraction path and endodontic access: Dilaceration is a sharp bend in the root or crown, usually from trauma to the developing tooth germ.',
      'B': 'Flossing efficacy is unrelated to the surgical/endodontic complications of root dilaceration. It fails this stem, which requires Extraction path and endodontic access: Dilaceration is a sharp bend in the root or crown, usually from trauma to the developing tooth germ.',
      'C': 'Clamp color coding is inventory convenience, not affected by dilaceration biomechanics. It fails this stem, which requires Extraction path and endodontic access: Dilaceration is a sharp bend in the root or crown, usually from trauma to the developing tooth germ.',
