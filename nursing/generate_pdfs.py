"""Generate specialty-specific undergraduate nursing PDF notes (5+ pages each)."""
...
def pdf_filename(specialty_key: str) -> str:
    return f"UG_Nursing_{specialty_key.title().replace(' ', '_')}_Notes.pdf"
...
def _header_footer(canvas, doc):
    ...
    canvas.drawString(2 * cm, 1.2 * cm, "CharaNas UG Nursing — study aid (not a textbook scan)")
